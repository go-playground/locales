...
func New() locales.Translator {
	return &ky{
		...
		timezones:              map[string]string{"OESZ": "Чыгыш Европа жайкы убактысы", "AEST": "Австралия чыгыш стандарт убактысы", "UYT": "Уругвай стандарт убактысы", "AKST": "Аляска стандарт убактысы", "∅∅∅": "Амазон жайкы убактысы", "SRT": "Суринаме убактысы", "AKDT": "Аляска жайкы убактысы", "ART": "Аргентина стандарт убактысы", "HADT": "Гавайи-Алеут жайкы убактысы", "TMST": "Түркмөнстан жайкы убактысы", "MDT": "Түндүк Америка, тоо жайкы убактысы", "CHADT": "Чатам күндүзгү убактысы", "JDT": "Жапан күндүзгү убактысы", "PDT": "Түндүк Америка, Тынч океан жайкы убактысы", "AEDT": "Австралия чыгыш күндүзгү убактысы", "SAST": "Түштүк Африка убактысы", "NZDT": "Жаңы Зеландия күндүзгү убактысы", "WAST": "Батыш Африка жайкы убактысы", "MEZ": "Борбордук Европа стандарт убактысы", "NZST": "Жаӊы Зеландия стандарт убактысы", "BOT": "Боливия убактысы", "WIB": "Батыш Индонезия убактысы", "OEZ": "Чыгыш Европа стандарт убактысы", "EAT": "Чыгыш Африка убактысы", "UYST": "Уругвай жайкы убактысы", "WIT": "Чыгыш Индонезия убактысы", "GFT": "Француз Гвиана убактысы", "IST": "Индия убактысы", "GMT": "Гринвич универсалдуу убактысы", "HKT": "Гонконг стандарт убактысы", "VET": "Венесуэла убактысы", "ACWST": "Австралия борбордук батыш стандарт убактысы", "ACWDT": "Австралия борбордук чыгыш күндүзгү убактысы", "PST": "Түндүк Америка, Тынч океан стандарт убактысы", "HAST": "Гавайи-Алеут стандарт убактысы", "CLST": "Чили жайкы убактысы", "HKST": "Гонконг жайкы убактысы", "AWST": "Австралия батыш стандарт убактысы", "WITA": "Борбордук Индонезия убактысы", "AWDT": "Австралия батыш күндүзгү убактысы", "JST": "Жапан стандарт убактысы", "WESZ": "Батыш Европа жайкы убактысы", "HAT": "Нюфаундлэнд жайкы убактысы", "COST": "Колумбия жайкы убактысы", "TMT": "Түркмөнстан стандарт убактысы", "CLT": "Чили стандарт убактысы", "ACDT": "Австралия борбордук күндүзгү убактысы", "ECT": "Экуадор убактысы", "AST": "Атлантика стандарт убактысы", "ADT": "Атлантика жайкы убактысы", "EDT": "Түндүк Америка, чыгыш жайкы убактысы", "MESZ": "Борбордук Европа жайкы убактысы", "SGT": "Сингапур убактысы", "COT": "Колумбия стандарт убактысы", "BT": "Бутан убактысы", "LHDT": "Лорд Хау күндүзгү убактысы", "MST": "Түндүк Америка, тоо стандарт убактысы", "WAT": "Батыш Африка стандарт убактысы", "HNT": "Нюфаундлэнд стандарт убактысы", "ChST": "Чаморро убактысы", "LHST": "Лорд Хау стандарт убактысы", "MYT": "Малайзия убактысы", "ACST": "Австралия борбордук стандарт убактысы", "WART": "Батыш Аргентина стандарт убактысы", "EST": "Түндүк Америка, чыгыш стандарт убактысы", "CAT": "Борбордук Африка убактысы", "WEZ": "Батыш Европа стандарт убактысы", "CST": "Түндүк Америка, борбордук стандарт убактысы", "CDT": "Түндүк Америка, борбордук жайкы убактысы", "GYT": "Гвиана убактысы", "WARST": "Батыш Аргентина жайкы убактысы", "CHAST": "Чатам стандарт убактысы", "ARST": "Аргентина жайкы убактысы"},
	}
}
