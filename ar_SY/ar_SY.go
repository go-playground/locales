...
func New() locales.Translator {
	return &ar_SY{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"TMST": "توقيت تركمانستان الصيفي", "ACDT": "توقيت وسط أستراليا الصيفي", "ARST": "توقيت الأرجنتين الصيفي", "IST": "توقيت الهند", "PST": "توقيت المحيط الهادي الرسمي", "COT": "توقيت كولومبيا الرسمي", "WIB": "توقيت غرب إندونيسيا", "BT": "توقيت بوتان", "CHAST": "توقيت تشاتام الرسمي", "HAST": "توقيت هاواي ألوتيان الرسمي", "AEST": "توقيت شرق أستراليا الرسمي", "WARST": "توقيت غرب الأرجنتين الصيفي", "HKT": "توقيت هونغ كونغ الرسمي", "WITA": "توقيت وسط إندونيسيا", "AWDT": "توقيت غرب أستراليا الصيفي", "TMT": "توقيت تركمانستان الرسمي", "∅∅∅": "توقيت برازيليا الصيفي", "AKDT": "توقيت ألاسكا الصيفي", "MESZ": "توقيت وسط أوروبا الصيفي", "MDT": "التوقيت الجبلي الصيفي لأمريكا الشمالية", "SGT": "توقيت سنغافورة", "CAT": "توقيت وسط أفريقيا", "GYT": "توقيت غيانا", "LHDT": "التوقيت الصيفي للورد هاو", "GFT": "توقيت غايانا الفرنسية", "JST": "توقيت اليابان الرسمي", "AKST": "التوقيت الرسمي لألاسكا", "ACWDT": "توقيت غرب وسط أستراليا الصيفي", "GMT": "توقيت غرينتش", "UYST": "توقيت أورغواي الصيفي", "MST": "التوقيت الجبلي الرسمي لأمريكا الشمالية", "CDT": "التوقيت الصيفي المركزي لأمريكا الشمالية", "AWST": "توقيت غرب أستراليا الرسمي", "MEZ": "توقيت وسط أوروبا الرسمي", "NZST": "توقيت نيوزيلندا الرسمي", "CHADT": "توقيت تشاتام الصيفي", "AST": "التوقيت الرسمي الأطلسي", "WAST": "توقيت غرب أفريقيا الصيفي", "CLT": "توقيت شيلي الرسمي", "WART": "توقيت غرب الأرجنتين الرسمي", "HKST": "توقيت هونغ كونغ الصيفي", "SAST": "توقيت جنوب أفريقيا", "EST": "التوقيت الرسمي الشرقي لأمريكا الشمالية", "WAT": "توقيت غرب أفريقيا الرسمي", "WEZ": "توقيت غرب أوروبا الرسمي", "HNT": "توقيت نيوفاوندلاند الرسمي", "WIT": "توقيت شرق إندونيسيا", "EAT": "توقيت شرق أفريقيا", "LHST": "توقيت لورد هاو الرسمي", "JDT": "توقيت اليابان الصيفي", "ADT": "التوقيت الصيفي الأطلسي", "COST": "توقيت كولومبيا الصيفي", "AEDT": "توقيت شرق أستراليا الصيفي", "MYT": "توقيت ماليزيا", "UYT": "توقيت أورغواي الرسمي", "OESZ": "توقيت شرق أوروبا الصيفي", "ChST": "توقيت تشامورو", "ART": "توقيت الأرجنتين الرسمي", "HADT": "توقيت هاواي ألوتيان الصيفي", "ACST": "توقيت وسط أستراليا الرسمي", "PDT": "توقيت المحيط الهادي الصيفي", "HAT": "توقيت نيوفاوندلاند الصيفي", "OEZ": "توقيت شرق أوروبا الرسمي", "CLST": "توقيت شيلي الصيفي", "CST": "التوقيت الرسمي المركزي لأمريكا الشمالية", "SRT": "توقيت سورينام", "ECT": "توقيت الإكوادور", "EDT": "التوقيت الصيفي الشرقي لأمريكا الشمالية", "WESZ": "توقيت غرب أوروبا الصيفي", "VET": "توقيت فنزويلا", "NZDT": "توقيت نيوزيلندا الصيفي", "BOT": "توقيت بوليفيا", "ACWST": "توقيت غرب وسط أستراليا الرسمي"},
	}
}
