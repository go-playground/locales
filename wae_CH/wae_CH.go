...
func New() locales.Translator {
	return &wae_CH{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"GYT": "GYT", "CHADT": "CHADT", "SAST": "SAST", "UYST": "UYST", "EAT": "EAT", "ACST": "ACST", "ACDT": "ACDT", "CST": "CST", "GFT": "GFT", "BOT": "BOT", "WIT": "WIT", "MESZ": "Mitteleuropäiši Summerzit", "LHST": "LHST", "MST": "MST", "AWST": "AWST", "AWDT": "AWDT", "JST": "JST", "EST": "EST", "TMST": "TMST", "AEST": "AEST", "AEDT": "AEDT", "LHDT": "LHDT", "TMT": "TMT", "MYT": "MYT", "HKST": "HKST", "ADT": "Atlantiši Summerzit", "NZST": "NZST", "WEZ": "Wešteuropäiši Standardzit", "WESZ": "Wešteuropäiši Summerzit", "HNT": "HNT", "ChST": "ChST", "JDT": "JDT", "EDT": "EDT", "HAT": "HAT", "CLST": "CLST", "∅∅∅": "∅∅∅", "AKST": "AKST", "OEZ": "Ošteuropäiši Standardzit", "CDT": "CDT", "PST": "PST", "NZDT": "NZDT", "BT": "BT", "CLT": "CLT", "UYT": "UYT", "ECT": "ECT", "VET": "VET", "ART": "ART", "CAT": "CAT", "WART": "WART", "AST": "Atlantiši Standardzit", "WITA": "WITA", "AKDT": "AKDT", "WIB": "WIB", "MDT": "MDT", "CHAST": "CHAST", "ACWST": "ACWST", "PDT": "PDT", "HADT": "HADT", "WAST": "WAST", "COT": "COT", "COST": "COST", "GMT": "GMT", "WARST": "WARST", "SRT": "SRT", "HKT": "HKT", "ACWDT": "ACWDT", "HAST": "HAST", "WAT": "WAT", "OESZ": "Ošteuropäiši Summerzit", "ARST": "ARST", "IST": "IST", "MEZ": "Mitteleuropäiši Standardzit", "SGT": "SGT"},
	}
}
