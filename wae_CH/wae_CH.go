...
// FmtDateTimeShort returns the short date & time representation of 't' for 'wae_CH'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (wae *wae_CH) FmtDateTimeShort(t time.Time) []byte {
...
// FmtDateTimeMedium returns the medium date & time representation of 't' for 'wae_CH'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (wae *wae_CH) FmtDateTimeMedium(t time.Time) []byte {
...
// FmtDateTimeLong returns the long date & time representation of 't' for 'wae_CH'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (wae *wae_CH) FmtDateTimeLong(t time.Time) []byte {
...
// FmtDateTimeFull returns the full date & time representation of 't' for 'wae_CH'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (wae *wae_CH) FmtDateTimeFull(t time.Time) []byte {
