...
func New() locales.Translator {
	return &sr_Latn{
		...
		timezones:              map[string]string{"CHADT": "Čatam letnje računanje vremena", "HAST": "Havajsko-aleutsko standardno vreme", "SGT": "Singapur standardno vreme", "WESZ": "Zapadnoevropsko letnje računanje vremena", "EAT": "Istočno-afričko vreme", "ACWDT": "Australijsko centralno zapadno letnje računanje vremena", "BT": "Butan vreme", "CHAST": "Čatam standardno vreme", "BOT": "Bolivija vreme", "WAT": "Zapadno-afričko standardno vreme", "AEST": "Australijsko istočno standardno vreme", "AWST": "Australijsko zapadno standardno vreme", "WEZ": "Zapadnoevropsko standardno vreme", "OESZ": "Istočnoevropsko letnje računanje vremena", "ART": "Argentina standardno vreme", "MESZ": "Srednjeevropsko letnje računanje vremena", "NZDT": "Novi Zeland letnje računanje vremena", "IST": "Indijsko standardno vreme", "ChST": "Čamoro vreme", "GYT": "Gvajana vreme", "GMT": "Srednje vreme po Griniču", "UYST": "Urugvaj letnje računanje vremena", "WART": "Zapadna Argentina standardno vreme", "ADT": "Atlansko ltnje računanje vremena", "PST": "Severnoamerički Pacifičko standardno vreme", "MEZ": "Srednjeevropsko standardno vreme", "SAST": "Južno-afričko vreme", "WIT": "Istočno-indonezijsko vreme", "CST": "Severnoamerički Centralno standardno vreme", "AWDT": "Australijsko zapadno letnje računanje vremena", "WIB": "Zapadno-indonezijsko vreme", "MYT": "Malezija vreme", "COT": "Kolumbija standardno vreme", "COST": "Kolumbija letnje računanje vremena", "JST": "Japansko standardno vreme", "HADT": "Havajsko-aleutsko letnje računanje vremena", "HAT": "Njufaundlend letnje računanje vremena", "SRT": "Surinam vreme", "ACST": "Australijsko centralno standardno vreme", "ACDT": "Australijsko centralno letnje računanje vremena", "VET": "Venecuela vreme", "HKST": "Hong Kong letnje računanje vremena", "OEZ": "Istočnoevropsko standardno vreme", "CLST": "Čile letnje računanje vremena", "GFT": "Francuska Gvajana vreme", "ACWST": "Australijsko centralno zapadno standardno vreme", "TMST": "Turkmenistan letnje računanje vremena", "ECT": "Ekvador vreme", "HKT": "Hong Kong standardno vreme", "JDT": "Japansko letnje računanje vremena", "CDT": "Severnoamerički Centralno letnje računanje vremena", "AST": "Atlansko standardno vreme", "LHDT": "Lord Hov letnje računanje vremena", "MDT": "Makao letnje računanje vremena", "ARST": "Argentina letnje računanje vremena", "AKDT": "Aljaska, letnje računanje vremena", "TMT": "Turkmenistan standardno vreme", "CLT": "Čile standardno vreme", "WAST": "Zapadno-afričko letnje računanje vremena", "AKST": "Aljaska, standardno vreme", "PDT": "Severnoamerički Pacifičko letnje računanje vremena", "NZST": "Novi Zeland standardno vreme", "EST": "Severnoamerički Istočno standardno vreme", "HNT": "Njufaundlend standardno vreme", "UYT": "Urugvaj standardno vreme", "WARST": "Zapadna Argentina letnje računanje vremena", "MST": "Makao standardno vreme", "WITA": "Centralno-indonezijsko vreme", "EDT": "Severnoamerički Istočno letnje računanje vremena", "CAT": "Centralno-afričko vreme", "∅∅∅": "Azori letnje računanje vremena", "AEDT": "Australijsko istočno letnje računanje vremena", "LHST": "Lord Hov standardno vreme"},
	}
}
