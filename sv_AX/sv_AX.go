...
func New() locales.Translator {
	return &sv_AX{
		...
		timezones:              map[string]string{"ACST": "centralaustralisk normaltid", "LHST": "Lord Howe, normaltid", "ACDT": "centralaustralisk sommartid", "OESZ": "östeuropeisk sommartid", "WARST": "västargentinsk sommartid", "ARST": "östargentinsk sommartid", "AKDT": "Alaska, sommartid", "EST": "östnordamerikansk normaltid", "CAT": "centralafrikansk tid", "GYT": "Guyanatid", "GMT": "Greenwichtid", "HKST": "Hongkong, sommartid", "AKST": "Alaska, normaltid", "HAST": "Honolulu, normaltid", "ChST": "Chamorrotid", "JDT": "japansk sommartid", "NZDT": "nyzeeländsk sommartid", "COST": "colombiansk sommartid", "TMT": "turkmensk normaltid", "CLST": "chilensk sommartid", "CDT": "centralnordamerikansk sommartid", "ACWST": "västcentralaustralisk normaltid", "HADT": "Honolulu, sommartid", "IST": "indisk tid", "CLT": "chilensk normaltid", "JST": "japansk normaltid", "EDT": "östnordamerikansk sommartid", "PST": "västnordamerikansk normaltid", "AEDT": "östaustralisk sommartid", "ECT": "ecuadoriansk tid", "MDT": "Macausommartid", "AWST": "västaustralisk normaltid", "ART": "östargentinsk normaltid", "OEZ": "östeuropeisk normaltid", "MYT": "malaysisk tid", "BT": "bhutansk tid", "EAT": "östafrikansk tid", "WITA": "centralindonesisk tid", "AST": "nordamerikansk atlantnormaltid", "ADT": "nordamerikansk atlantsommartid", "MESZ": "centraleuropeisk sommartid", "BOT": "boliviansk tid", "UYT": "uruguayansk normaltid", "WIT": "östindonesisk tid", "WART": "västargentinsk normaltid", "CHAST": "Chatham, normaltid", "CHADT": "Chatham, sommartid", "VET": "venezuelansk tid", "HKT": "Hongkong, normaltid", "SRT": "Surinamtid", "MST": "Macaunormaltid", "COT": "colombiansk normaltid", "WAT": "västafrikansk normaltid", "WAST": "västafrikansk sommartid", "NZST": "nyzeeländsk normaltid", "SAST": "sydafrikansk tid", "HNT": "Newfoundland, normaltid", "SGT": "Singaporetid", "PDT": "västnordamerikansk sommartid", "WIB": "västindonesisk tid", "GFT": "Franska Guyanatid", "WEZ": "västeuropeisk normaltid", "TMST": "turkmensk sommartid", "LHDT": "Lord Howe, sommartid", "CST": "centralnordamerikansk normaltid", "ACWDT": "västcentralaustralisk sommartid", "AWDT": "västaustralisk sommartid", "∅∅∅": "västbrasiliansk sommartid", "AEST": "östaustralisk normaltid", "MEZ": "centraleuropeisk normaltid", "WESZ": "västeuropeisk sommartid", "HAT": "Newfoundland, sommartid", "UYST": "uruguayansk sommartid"},
	}
}
