...
func New() locales.Translator {
	return &ar_YE{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"ART": "توقيت الأرجنتين الرسمي", "ACWDT": "توقيت غرب وسط أستراليا الصيفي", "PST": "توقيت المحيط الهادي الرسمي", "OESZ": "توقيت شرق أوروبا الصيفي", "MST": "التوقيت الجبلي الرسمي لأمريكا الشمالية", "AEST": "توقيت شرق أستراليا الرسمي", "EAT": "توقيت شرق أفريقيا", "HKT": "توقيت هونغ كونغ الرسمي", "JDT": "توقيت اليابان الصيفي", "AKDT": "توقيت ألاسكا الصيفي", "AST": "التوقيت الرسمي الأطلسي", "COST": "توقيت كولومبيا الصيفي", "TMT": "توقيت تركمانستان الرسمي", "BT": "توقيت بوتان", "VET": "توقيت فنزويلا", "SGT": "توقيت سنغافورة", "ARST": "توقيت الأرجنتين الصيفي", "IST": "توقيت الهند", "EST": "التوقيت الرسمي الشرقي لأمريكا الشمالية", "HADT": "توقيت هاواي ألوتيان الصيفي", "BOT": "توقيت بوليفيا", "WIB": "توقيت غرب إندونيسيا", "EDT": "التوقيت الصيفي الشرقي لأمريكا الشمالية", "SRT": "توقيت سورينام", "ACWST": "توقيت غرب وسط أستراليا الرسمي", "HAT": "توقيت نيوفاوندلاند الصيفي", "GMT": "توقيت غرينتش", "ChST": "توقيت تشامورو", "∅∅∅": "توقيت برازيليا الصيفي", "WESZ": "توقيت غرب أوروبا الصيفي", "CHAST": "توقيت تشاتام الرسمي", "MEZ": "توقيت وسط أوروبا الرسمي", "SAST": "توقيت جنوب أفريقيا", "WAT": "توقيت غرب أفريقيا الرسمي", "LHST": "توقيت لورد هاو الرسمي", "WITA": "توقيت وسط إندونيسيا", "MESZ": "توقيت وسط أوروبا الصيفي", "TMST": "توقيت تركمانستان الصيفي", "AEDT": "توقيت شرق أستراليا الصيفي", "ACST": "توقيت وسط أستراليا الرسمي", "ECT": "توقيت الإكوادور", "HAST": "توقيت هاواي ألوتيان الرسمي", "WAST": "توقيت غرب أفريقيا الصيفي", "CDT": "التوقيت الصيفي المركزي لأمريكا الشمالية", "WART": "توقيت غرب الأرجنتين الرسمي", "JST": "توقيت اليابان الرسمي", "CHADT": "توقيت تشاتام الصيفي", "CAT": "توقيت وسط أفريقيا", "MYT": "توقيت ماليزيا", "CLST": "توقيت شيلي الصيفي", "MDT": "التوقيت الجبلي الصيفي لأمريكا الشمالية", "AKST": "التوقيت الرسمي لألاسكا", "AWST": "توقيت غرب أستراليا الرسمي", "AWDT": "توقيت غرب أستراليا الصيفي", "NZDT": "توقيت نيوزيلندا الصيفي", "OEZ": "توقيت شرق أوروبا الرسمي", "UYST": "توقيت أورغواي الصيفي", "WARST": "توقيت غرب الأرجنتين الصيفي", "HKST": "توقيت هونغ كونغ الصيفي", "PDT": "توقيت المحيط الهادي الصيفي", "GFT": "توقيت غايانا الفرنسية", "WEZ": "توقيت غرب أوروبا الرسمي", "GYT": "توقيت غيانا", "UYT": "توقيت أورغواي الرسمي", "ACDT": "توقيت وسط أستراليا الصيفي", "LHDT": "التوقيت الصيفي للورد هاو", "CST": "التوقيت الرسمي المركزي لأمريكا الشمالية", "ADT": "التوقيت الصيفي الأطلسي", "NZST": "توقيت نيوزيلندا الرسمي", "COT": "توقيت كولومبيا الرسمي", "HNT": "توقيت نيوفاوندلاند الرسمي", "CLT": "توقيت شيلي الرسمي", "WIT": "توقيت شرق إندونيسيا"},
	}
}
