...
// FmtDateTimeShort returns the short date & time representation of 't' for 'my'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (my *my) FmtDateTimeShort(t time.Time) []byte {

	b := my.FmtDateShort(t)
	b = append(b, ' ')
	b = append(b, my.FmtTimeShort(t)...)

	return b
}

// FmtDateTimeMedium returns the medium date & time representation of 't' for 'my'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (my *my) FmtDateTimeMedium(t time.Time) []byte {

	b := my.FmtDateMedium(t)
	b = append(b, ' ')
	b = append(b, my.FmtTimeMedium(t)...)

	return b
}

// FmtDateTimeLong returns the long date & time representation of 't' for 'my'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (my *my) FmtDateTimeLong(t time.Time) []byte {

	b := my.FmtDateLong(t)
	b = append(b, ' ')
	b = append(b, my.FmtTimeLong(t)...)

	return b
}

// FmtDateTimeFull returns the full date & time representation of 't' for 'my'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (my *my) FmtDateTimeFull(t time.Time) []byte {

	b := my.FmtDateFull(t)
	b = append(b, ' ')
	b = append(b, my.FmtTimeFull(t)...)
