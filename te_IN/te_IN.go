...
func New() locales.Translator {
	return &te_IN{
		...
		timezones:              map[string]string{"ACWST": "మధ్యమ ఆస్ట్రేలియా పశ్చిమ ప్రామాణిక సమయం", "MEZ": "సెంట్రల్ యూరోపియన్ ప్రామాణిక సమయం", "∅∅∅": "అమెజాన్ వేసవి సమయం", "MST": "మౌంటేన్ ప్రామాణిక సమయం", "MYT": "మలేషియా సమయం", "AKST": "అలాస్కా ప్రామాణిక సమయం", "EDT": "తూర్పు పగటి సమయం", "COST": "కొలంబియా వేసవి సమయం", "OEZ": "తూర్పు యూరోపియన్ ప్రామాణిక సమయం", "JDT": "జపాన్ పగటి వెలుతురు సమయం", "MESZ": "సెంట్రల్ యూరోపియన్ వేసవి సమయం", "VET": "వెనిజులా సమయం", "AWST": "పశ్చిమ ఆస్ట్రేలియన్ ప్రామాణిక సమయం", "ARST": "ఆర్జెంటీనా వేసవి సమయం", "NZST": "న్యూజిల్యాండ్ ప్రామాణిక సమయం", "UYT": "ఉరుగ్వే ప్రామాణిక సమయం", "CHADT": "చాథమ్ పగటి వెలుతురు సమయం", "ART": "అర్జెంటీనా ప్రామాణిక సమయం", "TMT": "తుర్క్మెనిస్థాన్ ప్రామాణిక సమయం", "AEST": "తూర్పు ఆస్ట్రేలియా ప్రామాణిక సమయం", "WIT": "తూర్పు ఇండోనేషియా సమయం", "BOT": "బొలీవియా సమయం", "HNT": "న్యూఫౌండ్ ల్యాండ్ ప్రామాణిక సమయం", "SGT": "సింగపూర్ ప్రామాణిక సమయం", "WIB": "పశ్చిమ ఇండోనేషియా సమయం", "MDT": "మౌంటేన్ పగటి సమయం", "HADT": "హవాయ్-అల్యూషియన్ పగటి వెలుతురు సమయం", "ACST": "ఆస్ట్రేలియా మధ్యమ ప్రామాణిక సమయం", "ACDT": "ఆస్ట్రేలియా మధ్యమ పగటి సమయం", "ECT": "ఈక్వడార్ సమయం", "CDT": "మధ్యమ పగటి సమయం", "WARST": "పశ్చిమ అర్జెంటీనా వేసవి సమయం", "IST": "భారతదేశ సమయం", "COT": "కొలంబియా ప్రామాణిక సమయం", "WESZ": "పశ్చిమ యూరోపియన్ వేసవి సమయం", "OESZ": "తూర్పు యూరోపియన్ వేసవి సమయం", "CLST": "చిలీ వేసవి సమయం", "EAT": "తూర్పు ఆఫ్రికా సమయం", "GFT": "ఫ్రెంచ్ గయానా సమయం", "JST": "జపాన్ ప్రామాణిక సమయం", "AST": "అట్లాంటిక్ ప్రామాణిక సమయం", "ACWDT": "మధ్యమ ఆస్ట్రేలియన్ పశ్చిమ పగటి సమయం", "PDT": "పసిఫిక్ పగటి సమయం", "TMST": "తుర్క్మెనిస్థాన్ వేసవి సమయం", "BT": "భూటాన్ సమయం", "CST": "మధ్యమ ప్రామాణిక సమయం", "AWDT": "పశ్చిమ ఆస్ట్రేలియన్ పగటి సమయం", "NZDT": "న్యూజిల్యాండ్ పగటి వెలుతురు సమయం", "GMT": "గ్రీన్\u200cవిచ్ సగటు సమయం", "AEDT": "తూర్పు ఆస్ట్రేలియా పగటి సమయం", "HKST": "హాంకాంగ్ వేసవి సమయం", "PST": "పసిఫిక్ ప్రామాణిక సమయం", "HAT": "న్యూఫౌండ్ ల్యాండ్ పగటి సమయం", "ChST": "చామర్రో ప్రామాణిక సమయం", "WART": "పశ్చిమ అర్జెంటీనా ప్రామాణిక సమయం", "ADT": "అట్లాంటిక్ పగటి సమయం", "CAT": "సెంట్రల్ ఆఫ్రికా సమయం", "CLT": "చిలీ ప్రామాణిక సమయం", "LHST": "లార్డ్ హోవ్ ప్రామాణిక సమయం", "HKT": "హాంకాంగ్ ప్రామాణిక సమయం", "SAST": "దక్షిణ ఆఫ్రికా ప్రామాణిక సమయం", "WEZ": "పశ్చిమ యూరోపియన్ ప్రామాణిక సమయం", "UYST": "ఉరుగ్వే వేసవి సమయం", "CHAST": "చాథమ్ ప్రామాణిక సమయం", "WITA": "సెంట్రల్ ఇండోనేషియా సమయం", "AKDT": "అలాస్కా పగటి సమయం", "HAST": "హవాయ్-అల్యూషియన్ ప్రామాణిక సమయం", "EST": "తూర్పు ప్రామాణిక సమయం", "WAT": "పశ్చిమ ఆఫ్రికా ప్రామాణిక సమయం", "GYT": "గయానా సమయం", "LHDT": "లార్డ్ హోవ్ పగటి సమయం", "WAST": "పశ్చిమ ఆఫ్రికా వేసవి సమయం", "SRT": "సూరినామ్ సమయం"},
	}
}
