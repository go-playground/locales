...
func New() locales.Translator {
	return &ksh{
		...
		timezones:              map[string]string{"NZDT": "NZDT", "MESZ": "Meddel-Europpa sing Summerzick", "GMT": "Greenwich sing Standat-Zick", "CLST": "CLST", "WIT": "WIT", "ACST": "ACST", "JST": "JST", "NZST": "NZST", "MYT": "MYT", "GFT": "GFT", "MST": "MST", "AKDT": "AKDT", "ACWST": "ACWST", "SAST": "Söd-Affrekaanesche Zigg", "AEDT": "AEDT", "EAT": "Oß-Affrekaanesche Zigg", "SRT": "SRT", "COT": "COT", "CAT": "Zentraal-Affrekaanesche Zigg", "HNT": "HNT", "HAT": "HAT", "LHST": "LHST", "∅∅∅": "de Azore ier Summerzick", "AWST": "AWST", "WAST": "Wäß-Affrekaanesche Sommerzigg", "AST": "AST", "IST": "IST", "WEZ": "Weß-Europpa sing jewöhnlijje Zick", "LHDT": "LHDT", "CST": "CST", "HKST": "HKST", "WITA": "WITA", "CLT": "CLT", "HKT": "HKT", "WIB": "WIB", "TMST": "TMST", "ADT": "ADT", "COST": "COST", "OESZ": "Oß-Europpa sing Summerzick", "UYT": "UYT", "ACDT": "ACDT", "JDT": "JDT", "AKST": "AKST", "WESZ": "Weß-Europpa sing Summerzick", "OEZ": "Oß-Europpa sing jewöhnlijje Zick", "CHAST": "CHAST", "ACWDT": "ACWDT", "EST": "EST", "UYST": "UYST", "WART": "WART", "WAT": "Jewöhnlijje Wäß-Affrekaanesche Zigg", "SGT": "SGT", "AEST": "AEST", "GYT": "GYT", "MDT": "MDT", "HAST": "HAST", "HADT": "HADT", "PST": "PST", "BT": "BT", "CDT": "CDT", "WARST": "WARST", "ECT": "ECT", "ChST": "ChST", "AWDT": "AWDT", "BOT": "BOT", "EDT": "EDT", "CHADT": "CHADT", "VET": "VET", "TMT": "TMT", "MEZ": "Meddel-Europpa sing jewöhnlijje Zick", "ART": "ART", "ARST": "ARST", "PDT": "PDT"},
	}
}
...
func (ksh *ksh) FmtDateFull(t time.Time) string {
	...
	b = append(b, []byte{0x27, 0x64, 0xc3, 0xa4, 0x27, 0x20}...)
	b = strconv.AppendInt(b, int64(t.Day()), 10)
	b = append(b, []byte{0x2e, 0x20}...)
	b = append(b, ksh.monthsWide[t.Month()]...)
	b = append(b, []byte{0x20}...)
