...
func New() locales.Translator {
	return &kk{
		...
		timezones:              map[string]string{"AWDT": "Австралия жазғы батыс уақыты", "NZDT": "Жаңа Зеландия жазғы уақыты", "GYT": "Гайана уақыты", "AEST": "Австралия стандартты шығыс уақыты", "WIT": "Шығыс Индонезия уақыты", "GFT": "Француз Гвианасы уақыты", "COT": "Колумбия стандартты уақыты", "EAT": "Шығыс Африка уақыты", "HADT": "Гавай және Алеут аралдары жазғы уақыты", "WAST": "Батыс Африка жазғы уақыты", "WITA": "Орталық Индонезия уақыты", "GMT": "Гринвич уақыты", "JST": "Жапония стандартты уақыты", "MESZ": "Орталық Еуропа жазғы уақыты", "CHAST": "Чатем стандартты уақыты", "CHADT": "Чатем жазғы уақыты", "AEDT": "Австралия жазғы шығыс уақыты", "CLST": "Чили жазғы уақыты", "LHST": "Лорд-Хау стандартты уақыты", "WARST": "Батыс Аргентина жазғы уақыты", "∅∅∅": "Азор аралдары жазғы уақыты", "JDT": "Жапония жазғы уақыты", "PST": "Солтүстік Америка стандартты Тынық мұхиты уақыты", "ACWDT": "Австралия жазғы орталық-батыс уақыты", "MEZ": "Орталық Еуропа стандартты уақыты", "ChST": "Чаморро стандартты уақыты", "BT": "Бутан уақыты", "SGT": "Сингапур уақыты", "OESZ": "Шығыс Еуропа жазғы уақыты", "ADT": "Атлантика жазғы уақыты", "TMST": "Түрікменстан жазғы уақыты", "ARST": "Аргентина жазғы уақыты", "AWST": "Австралия стандартты батыс уақыты", "HNT": "Ньюфаундленд стандартты уақыты", "SRT": "Суринам уақыты", "MST": "MST", "HKST": "Гонконг жазғы уақыты", "EDT": "Солтүстік Америка жазғы шығыс уақыты", "COST": "Колумбия жазғы уақыты", "WIB": "Батыс Индонезия уақыты", "WESZ": "Батыс Еуропа жазғы уақыты", "HAT": "Ньюфаундленд жазғы уақыты", "OEZ": "Шығыс Еуропа стандартты уақыты", "ART": "Аргентина стандартты уақыты", "BOT": "Боливия уақыты", "ACST": "Австралия стандартты орталық уақыты", "MYT": "Малайзия уақыты", "UYT": "Уругвай стандартты уақыты", "MDT": "MDT", "PDT": "Солтүстік Америка жазғы Тынық мұхиты уақыты", "NZST": "Жаңа Зеландия стандартты уақыты", "SAST": "Оңтүстік Африка уақыты", "TMT": "Түрікменстан стандартты уақыты", "WAT": "Батыс Африка стандартты уақыты", "ACDT": "Австралия жазғы орталық уақыты", "ECT": "Эквадор уақыты", "HAST": "Гавай және Алеут аралдары стандартты уақыты", "WEZ": "Батыс Еуропа стандартты уақыты", "CLT": "Чили стандартты уақыты", "UYST": "Уругвай жазғы уақыты", "CST": "Солтүстік Америка стандартты орталық уақыты", "CDT": "Солтүстік Америка жазғы орталық уақыты", "AKST": "Аляска стандартты уақыты", "ACWST": "Австралия стандартты орталық-батыс уақыты", "AST": "Атлантика стандартты уақыты", "IST": "Үндістан стандартты уақыты", "EST": "Солтүстік Америка стандартты шығыс уақыты", "CAT": "Орталық Африка уақыты", "VET": "Венесуэла уақыты", "HKT": "Гонконг стандартты уақыты", "WART": "Батыс Аргентина стандартты уақыты", "AKDT": "Аляска жазғы уақыты", "LHDT": "Лорд-Хау жазғы уақыты"},
	}
}
