...
func New() locales.Translator {
	return &az_Latn_AZ{
		...
		timezones:              map[string]string{"CHAST": "Çatham Standart Vaxtı", "WITA": "Mərkəzi İndoneziya Vaxtı", "WAST": "Qərbi Afrika Yay Vaxtı", "GYT": "Qayana Vaxtı", "MDT": "MDT", "JDT": "Yaponiya Yay Vaxtı", "GMT": "Qrinviç Orta Vaxtı", "BT": "Butan Vaxtı", "LHST": "Lord Hau Standart Vaxtı", "EAT": "Şərqi Afrika Vaxtı", "ACDT": "Mərkəzi Avstraliya Yay Vaxtı", "HKT": "Honq Konq Standart Vaxtı", "AWST": "Qərbi Avstraliya Standart Vaxtı", "PST": "Şimali Amerika Sakit Okean Standart Vaxtı", "CAT": "Mərkəzi Afrika Vaxtı", "WAT": "Qərbi Afrika Standart Vaxtı", "AEDT": "Şərqi Avstraliya Yay Vaxtı", "ACST": "Mərkəzi Avstraliya Standart Vaxtı", "SRT": "Surinam Vaxtı", "AST": "Atlantik Standart Vaxt", "OESZ": "Şərqi Avropa Yay Vaxtı", "ARST": "Argentina Yay Vaxtı", "PDT": "Şimali Amerika Sakit Okean Yay Vaxtı", "WARST": "Qərbi Argentina Yay Vaxtı", "ADT": "Atlantik Yay Vaxtı", "ART": "Argentina Standart Vaxtı", "ChST": "Çamorro Vaxtı", "ECT": "Ekvador Vaxtı", "ACWST": "Mərkəzi Qərbi Avstraliya Standart Vaxtı", "ACWDT": "Mərkəzi Qərbi Avstraliya Yay Vaxtı", "IST": "Hindistan Vaxtı", "EST": "Şimali Şərqi Amerika Standart Vaxtı", "MEZ": "Mərkəzi Avropa Standart Vaxtı", "HAT": "Nyufaundlend Yay Vaxtı", "CLT": "Çili Standart Vaxtı", "AKDT": "Alyaska Yay Vaxtı", "NZDT": "Yeni Zelandiya Yay Vaxtı", "WEZ": "Qərbi Avropa Standart Vaxtı", "CLST": "Çili Yay Vaxtı", "∅∅∅": "Azor Yay Vaxtı", "HKST": "Honq Konq Yay Vaxtı", "VET": "Venesuela Vaxtı", "AKST": "Alyaska Standart Vaxtı", "SAST": "Cənubi Afrika Vaxtı", "TMT": "Türkmənistan Standart Vaxtı", "WESZ": "Qərbi Avropa Yay Vaxtı", "EDT": "Şimali Şərqi Amerika Yay Vaxtı", "HAST": "Havay-Aleut Standart Vaxtı", "HADT": "Havay-Aleut Yay Vaxtı", "WART": "Qərbi Argentina Standart Vaxtı", "TMST": "Türkmənistan Yay Vaxtı", "HNT": "Nyufaundlend Standart Vaxtı", "UYST": "Uruqvay Yay Vaxtı", "CST": "Şimali Mərkəzi Amerika Standart Vaxtı", "CDT": "Şimali Mərkəzi Amerika Yay Vaxtı", "GFT": "Fransız Qvianası Vaxtı", "OEZ": "Şərqi Avropa Standart Vaxtı", "AWDT": "Qərbi Avstraliya Yay Vaxtı", "COST": "Kolumbiya Yay Vaxtı", "UYT": "Uruqvay Standart Vaxtı", "JST": "Yaponiya Standart Vaxtı", "BOT": "Boliviya Vaxtı", "COT": "Kolumbiya Standart Vaxtı", "WIB": "Qərbi İndoneziya Vaxtı", "AEST": "Şərqi Avstraliya Standart Vaxtı", "LHDT": "Lord Hau Yay vaxtı", "MST": "MST", "MESZ": "Mərkəzi Avropa Yay Vaxtı", "NZST": "Yeni Zelandiya Standart Vaxtı", "WIT": "Şərqi İndoneziya Vaxtı", "CHADT": "Çatham Yay Vaxtı", "SGT": "Sinqapur Vaxtı", "MYT": "Malayziya Vaxtı"},
	}
}
