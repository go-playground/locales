...
func New() locales.Translator {
	return &hu{
		...
		timezones:              map[string]string{"CST": "középső államokbeli zónaidő", "ECT": "ecuadori téli idő", "HADT": "hawaii-aleuti nyári idő", "OEZ": "kelet-európai téli idő", "ACDT": "közép-ausztráliai nyári idő", "BOT": "bolíviai téli idő", "COT": "kolumbiai téli idő", "HNT": "új-fundlandi zónaidő", "WIB": "nyugat-indonéziai téli idő", "EAT": "kelet-afrikai téli idő", "SRT": "szurinámi idő", "UYT": "uruguayi téli idő", "∅∅∅": "azori nyári idő", "CHADT": "chathami nyári idő", "AWST": "nyugat-ausztráliai téli idő", "MESZ": "közép-európai nyári idő", "ACST": "közép-ausztráliai téli idő", "WITA": "közép-indonéziai idő", "HAST": "hawaii-aleuti téli idő", "PDT": "csendes-óceáni nyári idő", "JDT": "japán nyári idő", "AEDT": "kelet-ausztráliai nyári idő", "MST": "Macaui zónaidő", "IST": "indiai téli idő", "GYT": "guyanai téli idő", "UYST": "uruguayi nyári idő", "MDT": "Macaui nyári idő", "TMST": "türkmenisztáni nyári idő", "HAT": "új-fundlandi nyári idő", "WAT": "nyugat-afrikai téli idő", "WESZ": "nyugat-európai nyári idő", "OESZ": "kelet-európai nyári idő", "ChST": "chamorrói téli idő", "CLST": "chilei nyári idő", "JST": "japán téli idő", "AWDT": "nyugat-ausztráliai nyári idő", "COST": "kolumbiai nyári idő", "WIT": "kelet-indonéziai idő", "MYT": "malajziai idő", "WARST": "nyugat-argentínai nyári idő", "LHDT": "Lord Howe-szigeti nyári idő", "ARST": "Argentínai nyári idő", "SAST": "dél-afrikai téli idő", "CLT": "chilei téli idő", "ART": "argentínai téli idő", "CDT": "középső államokbeli nyári idő", "ACWST": "közép-nyugat-ausztráliai téli idő", "SGT": "szingapúri téli idő", "AEST": "kelet-ausztráliai téli idő", "HKT": "hongkongi téli idő", "HKST": "hongkongi nyári idő", "AKST": "alaszkai zónaidő", "GMT": "greenwichi középidő, téli idő", "WEZ": "nyugat-európai téli idő", "LHST": "Lord Howe-szigeti téli idő", "WART": "nyugat-argentínai téli idő", "CHAST": "chathami téli idő", "ACWDT": "közép-nyugat-ausztráliai nyári idő", "EDT": "keleti államokbeli nyári idő", "EST": "keleti államokbeli zónaidő", "PST": "csendes-óceáni zónaidő", "MEZ": "közép-európai téli idő", "CAT": "közép-afrikai téli idő", "GFT": "francia-guianai idő", "AST": "atlanti-óceáni zónaidő", "ADT": "atlanti-óceáni nyári idő", "NZDT": "új-zélandi nyári idő", "TMT": "türkmenisztáni téli idő", "WAST": "nyugat-afrikai nyári idő", "BT": "butáni idő", "VET": "venezuelai idő", "AKDT": "alaszkai nyári idő", "NZST": "új-zélandi téli idő"},
	}
}
