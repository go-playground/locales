...
func New() locales.Translator {
	return &nb{
		...
		timezones:              map[string]string{"UYT": "uruguayansk normaltid", "ACDT": "sentralaustralsk sommertid", "∅∅∅": "sommertid for Amazonas", "WEZ": "vesteuropeisk normaltid", "ChST": "tidssone for Chamorro", "GYT": "guyansk tid", "EAT": "østafrikansk tid", "MYT": "malaysisk tid", "PST": "normaltid for den nordamerikanske Stillehavskysten", "UYST": "uruguayansk sommertid", "SRT": "surinamsk tid", "ACWST": "vest-sentralaustralsk normaltid", "WITA": "sentralindonesisk tid", "AEST": "østaustralsk normaltid", "MDT": "sommertid for Rocky Mountains (USA)", "HAST": "normaltid for Hawaii og Aleutene", "WAT": "vestafrikansk normaltid", "WESZ": "vesteuropeisk sommertid", "HAT": "sommertid for Newfoundland", "WIB": "vestindonesisk tid", "GMT": "Greenwich middeltid", "ACST": "sentralaustralsk normaltid", "ECT": "ecuadoriansk tid", "AKDT": "alaskisk sommertid", "PDT": "sommertid for den nordamerikanske Stillehavskysten", "MEZ": "sentraleuropeisk normaltid", "LHST": "normaltid for Lord Howe-øya", "MST": "normaltid for Rocky Mountains (USA)", "WIT": "østindonesisk tid", "SAST": "sørafrikansk tid", "NZST": "newzealandsk normaltid", "HNT": "normaltid for Newfoundland", "BT": "bhutansk tid", "AKST": "alaskisk normaltid", "JDT": "japansk sommertid", "OEZ": "østeuropeisk normaltid", "VET": "venezuelansk tid", "AST": "atlanterhavskystlig standardtid", "ARST": "argentinsk sommertid", "JST": "japansk normaltid", "HADT": "sommertid for Hawaii og Aleutene", "CLT": "chilensk normaltid", "CST": "normaltid for det sentrale Nord-Amerika", "WARST": "vestargentinsk sommertid", "HKT": "normaltid for Hongkong", "ACWDT": "vest-sentralaustralsk sommertid", "WAST": "vestafrikansk sommertid", "BOT": "boliviansk tid", "GFT": "tidssone for Fransk Guyana", "CHADT": "sommertid for Chatham", "AWDT": "vestaustralsk sommertid", "COST": "colombiansk sommertid", "TMST": "turkmensk sommertid", "OESZ": "østeuropeisk sommertid", "CLST": "chilensk sommertid", "AWST": "vestaustralsk normaltid", "TMT": "turkmensk normaltid", "ADT": "atlanterhavskystlig sommertid", "EST": "normaltid for den nordamerikanske østkysten", "MESZ": "sentraleuropeisk sommertid", "NZDT": "newzealandsk sommertid", "WART": "vestargentinsk normaltid", "HKST": "sommertid for Hongkong", "CHAST": "normaltid for Chatham", "EDT": "sommertid for den nordamerikanske østkysten", "SGT": "singaporsk tid", "COT": "colombiansk normaltid", "AEDT": "østaustralsk sommertid", "CDT": "sommertid for det sentrale Nord-Amerika", "ART": "argentinsk normaltid", "IST": "indisk tid", "CAT": "sentralafrikansk tid", "LHDT": "sommertid for Lord Howe-øya"},
	}
}
