...
func New() locales.Translator {
	return &nb_SJ{
		...
		timezones:              map[string]string{"ACWST": "vest-sentralaustralsk normaltid", "AWST": "vestaustralsk normaltid", "ART": "argentinsk normaltid", "EST": "normaltid for den nordamerikanske østkysten", "HAT": "sommertid for Newfoundland", "EAT": "østafrikansk tid", "MYT": "malaysisk tid", "WITA": "sentralindonesisk tid", "∅∅∅": "sommertid for Amazonas", "WIB": "vestindonesisk tid", "OESZ": "østeuropeisk sommertid", "AEST": "østaustralsk normaltid", "GYT": "guyansk tid", "SRT": "surinamsk tid", "AKDT": "alaskisk sommertid", "CAT": "sentralafrikansk tid", "COT": "colombiansk normaltid", "GMT": "Greenwich middeltid", "BT": "bhutansk tid", "ACST": "sentralaustralsk normaltid", "NZST": "newzealandsk normaltid", "WAST": "vestafrikansk sommertid", "CLST": "chilensk sommertid", "CST": "normaltid for det sentrale Nord-Amerika", "HKST": "sommertid for Hongkong", "WIT": "østindonesisk tid", "MST": "Macau, standardtid", "HKT": "normaltid for Hongkong", "JDT": "japansk sommertid", "PST": "normaltid for den nordamerikanske Stillehavskysten", "HAST": "normaltid for Hawaii og Aleutene", "WEZ": "vesteuropeisk normaltid", "OEZ": "østeuropeisk normaltid", "VET": "venezuelansk tid", "AST": "atlanterhavskystlig standardtid", "IST": "indisk tid", "LHDT": "sommertid for Lord Howe-øya", "WART": "vestargentinsk normaltid", "WARST": "vestargentinsk sommertid", "MDT": "Macau, sommertid", "MEZ": "sentraleuropeisk normaltid", "TMST": "turkmensk sommertid", "AKST": "alaskisk normaltid", "PDT": "sommertid for den nordamerikanske Stillehavskysten", "ACWDT": "vest-sentralaustralsk sommertid", "ChST": "tidssone for Chamorro", "MESZ": "sentraleuropeisk sommertid", "WESZ": "vesteuropeisk sommertid", "COST": "colombiansk sommertid", "CLT": "chilensk normaltid", "GFT": "tidssone for Fransk Guyana", "CHAST": "normaltid for Chatham", "AWDT": "vestaustralsk sommertid", "HADT": "sommertid for Hawaii og Aleutene", "NZDT": "newzealandsk sommertid", "LHST": "normaltid for Lord Howe-øya", "ADT": "atlanterhavskystlig sommertid", "JST": "japansk normaltid", "WAT": "vestafrikansk normaltid", "SGT": "singaporsk tid", "ARST": "argentinsk sommertid", "TMT": "turkmensk normaltid", "UYST": "uruguayansk sommertid", "ACDT": "sentralaustralsk sommertid", "ECT": "ecuadoriansk tid", "SAST": "sørafrikansk tid", "HNT": "normaltid for Newfoundland", "AEDT": "østaustralsk sommertid", "UYT": "uruguayansk normaltid", "CHADT": "sommertid for Chatham", "BOT": "boliviansk tid", "EDT": "sommertid for den nordamerikanske østkysten", "CDT": "sommertid for det sentrale Nord-Amerika"},
	}
}
