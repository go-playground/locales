...
func New() locales.Translator {
	return &kk_KZ{
		...
		timezones:              map[string]string{"ACDT": "Австралия жазғы орталық уақыты", "GFT": "Француз Гвианасы уақыты", "AST": "Атлантика стандартты уақыты", "ACWDT": "Австралия жазғы орталық-батыс уақыты", "HADT": "Гавай және Алеут аралдары жазғы уақыты", "WESZ": "Батыс Еуропа жазғы уақыты", "GMT": "Гринвич уақыты", "MST": "Солтүстік Америка стандартты тау уақыты", "JST": "Жапония стандартты уақыты", "HNT": "Ньюфаундленд стандартты уақыты", "AEDT": "Австралия жазғы шығыс уақыты", "GYT": "Гайана уақыты", "LHST": "Лорд-Хау стандартты уақыты", "JDT": "Жапония жазғы уақыты", "SAST": "Оңтүстік Африка уақыты", "WIB": "Батыс Индонезия уақыты", "WAST": "Батыс Африка жазғы уақыты", "CST": "Солтүстік Америка стандартты орталық уақыты", "CDT": "Солтүстік Америка жазғы орталық уақыты", "ADT": "Атлантика жазғы уақыты", "AWST": "Австралия стандартты батыс уақыты", "WITA": "Орталық Индонезия уақыты", "NZST": "Жаңа Зеландия стандартты уақыты", "CAT": "Орталық Африка уақыты", "UYST": "Уругвай жазғы уақыты", "WARST": "Батыс Аргентина жазғы уақыты", "VET": "Венесуэла уақыты", "IST": "Үндістан стандартты уақыты", "PST": "Солтүстік Америка стандартты Тынық мұхиты уақыты", "NZDT": "Жаңа Зеландия жазғы уақыты", "MEZ": "Орталық Еуропа стандартты уақыты", "COST": "Колумбия жазғы уақыты", "ChST": "Чаморро стандартты уақыты", "CLT": "Чили стандартты уақыты", "SRT": "Суринам уақыты", "ART": "Аргентина стандартты уақыты", "SGT": "Сингапур уақыты", "EAT": "Шығыс Африка уақыты", "HKT": "Гонконг стандартты уақыты", "ACWST": "Австралия стандартты орталық-батыс уақыты", "HAT": "Ньюфаундленд жазғы уақыты", "UYT": "Уругвай стандартты уақыты", "WEZ": "Батыс Еуропа стандартты уақыты", "MDT": "Солтүстік Америка жазғы тау уақыты", "ACST": "Австралия стандартты орталық уақыты", "WART": "Батыс Аргентина стандартты уақыты", "AKDT": "Аляска жазғы уақыты", "ARST": "Аргентина жазғы уақыты", "BOT": "Боливия уақыты", "EDT": "Солтүстік Америка жазғы шығыс уақыты", "CLST": "Чили жазғы уақыты", "AWDT": "Австралия жазғы батыс уақыты", "HAST": "Гавай және Алеут аралдары стандартты уақыты", "OESZ": "Шығыс Еуропа жазғы уақыты", "MYT": "Малайзия уақыты", "CHADT": "Чатем жазғы уақыты", "AEST": "Австралия стандартты шығыс уақыты", "CHAST": "Чатем стандартты уақыты", "TMT": "Түрікменстан стандартты уақыты", "WAT": "Батыс Африка стандартты уақыты", "HKST": "Гонконг жазғы уақыты", "ECT": "Эквадор уақыты", "AKST": "Аляска стандартты уақыты", "EST": "Солтүстік Америка стандартты шығыс уақыты", "MESZ": "Орталық Еуропа жазғы уақыты", "BT": "Бутан уақыты", "∅∅∅": "Бразилия жазғы уақыты", "PDT": "Солтүстік Америка жазғы Тынық мұхиты уақыты", "TMST": "Түрікменстан жазғы уақыты", "OEZ": "Шығыс Еуропа стандартты уақыты", "WIT": "Шығыс Индонезия уақыты", "LHDT": "Лорд-Хау жазғы уақыты", "COT": "Колумбия стандартты уақыты"},
	}
}
