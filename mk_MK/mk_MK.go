...
func New() locales.Translator {
	return &mk_MK{
		...
		timezones:              map[string]string{"VET": "Време во Венецуела", "AWDT": "Летно сметање на времето во Западна Австралија", "HADT": "Летно сметање на времето во Хаваи - Алеутски острови", "BOT": "Време во Боливија", "HAT": "Летно сметање на времето на Њуфаундленд", "TMST": "Летно време во Туркменистан", "WARST": "Летно сметање на времето во западна Аргентина", "MDT": "MDT", "CHADT": "Летно сметање на времето во Четем", "AWST": "Стандардно време во Западна Австралија", "JDT": "Летно сметање на времето во Јапонија", "PST": "Пацифичко стандардно време", "PDT": "Пацифичко летно сметање на времето", "MEZ": "Средноевропско стандардно време", "WEZ": "Западноевропско стандардно време", "ACDT": "Летно сметање на времето во Централна Австралија", "CHAST": "Стандардно време во Четем", "AKDT": "Летно сметање на времето во Аљаска", "ACWST": "Стандардно време во Централна и Западна Австралија", "HAST": "Стандардно време во Хаваи - Алеутски острови", "GMT": "Средно време по Гринич", "AEST": "Стандардно време во Источна Австралија", "BT": "Време во Бутан", "MST": "MST", "EDT": "Источно летно сметање на времето", "OEZ": "Источноевропско стандардно време", "LHDT": "Летно сметање на времето во Лорд Хау", "UYT": "Стандардно време во Уругвај", "ARST": "Летно сметање на времето во Аргентина", "WITA": "Време во Централна Индонезија", "OESZ": "Источноевропско летно време", "MYT": "Време во Малезија", "AKST": "Стандардно време во Аљаска", "COT": "Стандардно време во Колумбија", "COST": "Летно сметање на времето во Колумбија", "CLT": "Стандардно време во Чиле", "CLST": "Летно сметање на времето во Чиле", "SRT": "Време во Суринам", "GFT": "Време во Француска Гвајана", "TMT": "Стандардно време во Туркменистан", "GYT": "Време во Гвајана", "LHST": "Стандардно време во Лорд Хау", "∅∅∅": "Летно време во Азорес", "AST": "Атлантско стандардно време", "JST": "Стандардно време во Јапонија", "SAST": "Време во Јужноафриканска Република", "EST": "Источно стандардно време", "NZDT": "Летно сметање на времето во Нов Зеланд", "HNT": "Стандардно време на Њуфаундленд", "ACST": "Стандардно време во Централна Австралија", "HKT": "Стандардно време во Хонг Конг", "UYST": "Летно сметање на времето во Уругвај", "ADT": "Атлантско летно сметање на времето", "ECT": "Време во Еквадор", "ACWDT": "Летно сметање на времето во Централна и Западна Австралија", "ART": "Стандардно време во Аргентина", "WESZ": "Западноевропско летно време", "EAT": "Источноафриканско време", "WIT": "Време во Источна Индонезија", "HKST": "Летно време во Хонг Конг", "SGT": "Време во Сингапур", "IST": "Време во Индија", "NZST": "Стандардно време во Нов Зеланд", "CAT": "Средноафриканско време", "WAT": "Западноафриканско стандардно време", "ChST": "Време во Чаморо", "CST": "Централно стандардно време во Северна Америка", "CDT": "Централно летно сметање на времето", "WART": "Стандардно време во западна Аргентина", "MESZ": "Средноевропско летно време", "WAST": "Западноафриканско летно сметање на времето", "WIB": "Време во Западна Индонезија", "AEDT": "Летно сметање на времето во Источна Австралија"},
	}
}
