...
func New() locales.Translator {
	return &lb_LU{
		...
		timezones:              map[string]string{"LHST": "Lord-Howe-Normalzäit", "HKT": "Hong-Kong-Normalzäit", "JDT": "Japanesch Summerzäit", "ACWDT": "Zentral-/Westaustralesch Summerzäit", "HADT": "Hawaii-Aleuten-Summerzäit", "EST": "Nordamerikanesch Ostküsten-Normalzäit", "CLT": "Chilenesch Normalzäit", "BT": "Bhutan-Zäit", "AEDT": "Ostaustralesch Summerzäit", "MESZ": "Mëtteleuropäesch Summerzäit", "PDT": "Nordamerikanesch Westküsten-Summerzäit", "TMT": "Turkmenistan-Normalzäit", "HNT": "Neifundland-Normalzäit", "OESZ": "Osteuropäesch Summerzäit", "SRT": "Suriname-Zäit", "AST": "Atlantik-Normalzäit", "BOT": "Bolivianesch Zäit", "SGT": "Singapur-Standardzäit", "GYT": "Guyana-Zäit", "GMT": "Mëttler Greenwich-Zäit", "CDT": "Nordamerikanesch Inland-Summerzäit", "ADT": "Atlantik-Summerzäit", "TMST": "Turkmenistan-Summerzäit", "OEZ": "Osteuropäesch Normalzäit", "MST": "Rocky-Mountain-Normalzäit", "WITA": "Zentralindonesesch Zäit", "ARST": "Argentinesch Summerzäit", "WIT": "Ostindonesesch Zäit", "WARST": "Westargentinesch Summerzäit", "AKST": "Alaska-Normalzäit", "AKDT": "Alaska-Summerzäit", "UYT": "Uruguyanesch Normalzäit", "ACDT": "Zentralaustralesch Summerzäit", "COST": "Kolumbianesch Summerzäit", "CHAST": "Chatham-Normalzäit", "EDT": "Nordamerikanesch Ostküsten-Summerzäit", "CST": "Nordamerikanesch Inland-Normalzäit", "HKST": "Hong-Kong-Summerzäit", "AEST": "Ostaustralesch Normalzäit", "ChST": "Chamorro-Zäit", "SAST": "Südafrikanesch Zäit", "CAT": "Zentralafrikanesch Zäit", "CHADT": "Chatham-Summerzäit", "PST": "Nordamerikanesch Westküsten-Normalzäit", "COT": "Kolumbianesch Normalzäit", "WESZ": "Westeuropäesch Summerzäit", "HAT": "Neifundland-Summerzäit", "CLST": "Chilenesch Summerzäit", "UYST": "Uruguayanesch Summerzäit", "ECT": "Ecuadorianesch Zäit", "ACWST": "Zentral-/Westaustralesch Normalzäit", "NZDT": "Neiséiland-Summerzäit", "WART": "Westargentinesch Normalzäit", "VET": "Venezuela-Zäit", "EAT": "Ostafrikanesch Zäit", "HAST": "Hawaii-Aleuten-Normalzäit", "MEZ": "Mëtteleuropäesch Normalzäit", "WIB": "Westindonesesch Zäit", "WAST": "Westafrikanesch Summerzäit", "WEZ": "Westeuropäesch Normalzäit", "MDT": "Rocky-Mountain-Summerzäit", "ACST": "Zentralaustralesch Normalzäit", "AWDT": "Westaustralesch Summerzäit", "∅∅∅": "Brasília-Summerzäit", "ART": "Argentinesch Normalzäit", "GFT": "Franséisch-Guayane-Zäit", "AWST": "Westaustralesch Normalzäit", "MYT": "Malaysesch Zäit", "LHDT": "Lord-Howe-Summerzäit", "IST": "Indesch Zäit", "WAT": "Westafrikanesch Normalzäit", "JST": "Japanesch Normalzäit", "NZST": "Neiséiland-Normalzäit"},
	}
}
