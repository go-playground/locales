...
func New() locales.Translator {
	return &sv_FI{
		...
		timezones:              map[string]string{"OEZ": "östeuropeisk normaltid", "CHAST": "Chatham, normaltid", "ECT": "ecuadoriansk tid", "HAST": "Honolulu, normaltid", "WAST": "västafrikansk sommartid", "HAT": "Newfoundland, sommartid", "WIB": "västindonesisk tid", "UYST": "uruguayansk sommartid", "WITA": "centralindonesisk tid", "ART": "östargentinsk normaltid", "ARST": "östargentinsk sommartid", "BOT": "boliviansk tid", "COST": "colombiansk sommartid", "ACDT": "centralaustralisk sommartid", "VET": "venezuelansk tid", "ADT": "nordamerikansk atlantsommartid", "AWST": "västaustralisk normaltid", "COT": "colombiansk normaltid", "GYT": "Guyanatid", "HADT": "Honolulu, sommartid", "EST": "östnordamerikansk normaltid", "HNT": "Newfoundland, normaltid", "AEDT": "östaustralisk sommartid", "LHDT": "Lord Howe, sommartid", "CST": "centralnordamerikansk normaltid", "CAT": "centralafrikansk tid", "WEZ": "västeuropeisk normaltid", "BT": "bhutansk tid", "JST": "japansk normaltid", "AKDT": "Alaska, sommartid", "AWDT": "västaustralisk sommartid", "PDT": "västnordamerikansk sommartid", "MESZ": "centraleuropeisk sommartid", "NZST": "nyzeeländsk normaltid", "NZDT": "nyzeeländsk sommartid", "EDT": "östnordamerikansk sommartid", "TMST": "turkmensk sommartid", "WAT": "västafrikansk normaltid", "CHADT": "Chatham, sommartid", "EAT": "östafrikansk tid", "CLT": "chilensk normaltid", "SRT": "Surinamtid", "AKST": "Alaska, normaltid", "ACWST": "västcentralaustralisk normaltid", "SAST": "sydafrikansk tid", "IST": "indisk tid", "AEST": "östaustralisk normaltid", "∅∅∅": "azorisk sommartid", "MST": "Macaunormaltid", "SGT": "Singaporetid", "CDT": "centralnordamerikansk sommartid", "ACST": "centralaustralisk normaltid", "ACWDT": "västcentralaustralisk sommartid", "MEZ": "centraleuropeisk normaltid", "GFT": "Franska Guyanatid", "JDT": "japansk sommartid", "TMT": "turkmensk normaltid", "WART": "västargentinsk normaltid", "LHST": "Lord Howe, normaltid", "MDT": "Macausommartid", "PST": "västnordamerikansk normaltid", "WESZ": "västeuropeisk sommartid", "GMT": "Greenwichtid", "WIT": "östindonesisk tid", "WARST": "västargentinsk sommartid", "HKT": "Hongkong, normaltid", "HKST": "Hongkong, sommartid", "ChST": "Chamorrotid", "UYT": "uruguayansk normaltid", "MYT": "malaysisk tid", "AST": "nordamerikansk atlantnormaltid", "OESZ": "östeuropeisk sommartid", "CLST": "chilensk sommartid"},
	}
}
