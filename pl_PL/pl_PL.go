...
func New() locales.Translator {
	return &pl_PL{
		...
		timezones:              map[string]string{"EST": "Czas wschodnioamerykański standardowy", "WAT": "Czas zachodnioafrykański standardowy", "GMT": "Czas uniwersalny", "ACWST": "Czas środkowo-zachodnioaustralijski standardowy", "IST": "Czas indyjski", "HNT": "Nowa Fundlandia (czas standardowy)", "SGT": "Singapur", "OEZ": "Czas wschodnioeuropejski standardowy", "AEST": "Czas standardowy wschodnioaustraliski", "AST": "Czas standardowy atlantycki", "ADT": "Czas atlantycki letni", "MEZ": "Czas środkowoeuropejski standardowy", "WAST": "Czas zachodnioafrykański letni", "CLT": "Chile (czas standardowy)", "CLST": "Chile (czas letni)", "WARST": "Argentyna Zachodnia (czas letni)", "TMST": "Turkmenistan (czas letni)", "COT": "Kolumbia (czas standardowy)", "AEDT": "Czas wschodnioaustraliski letni", "WIT": "Indonezja Wschodnia", "AKDT": "Alaska (czas letni)", "CDT": "Czas środkowoamerykański letni", "WART": "Argentyna Zachodnia (czas standardowy)", "MDT": "MDT", "JDT": "Japonia (czas letni)", "HAST": "Hawaje-Aleuty (czas standardowy)", "CST": "Czas środkowoamerykański standardowy", "SRT": "Surinam", "MST": "MST", "ART": "Argentyna (czas standardowy)", "WITA": "Indonezja Środkowa", "NZST": "Nowa Zelandia (czas standardowy)", "ACST": "Czas środkowoaustralijski standardowy", "ARST": "Argentyna (czas letni)", "ECT": "Ekwador", "LHST": "Lord Howe (czas standardowy)", "JST": "Japonia (czas standardowy)", "PDT": "Czas pacyficzny letni", "COST": "Kolumbia (czas letni)", "BT": "Bhutan", "VET": "Wenezuela", "ACWDT": "Czas środkowo-zachodnioaustralijski letni", "AWST": "Czas zachodnioaustralijski standardowy", "SAST": "Czas południowoafrykański", "EDT": "Czas wschodnioamerykański letni", "MESZ": "Czas środkowoeuropejski letni", "OESZ": "Czas wschodnioeuropejski letni", "UYST": "Urugwaj (czas letni)", "CHAST": "Chatham (czas standardowy)", "AWDT": "Czas zachodnioaustralijski letni", "PST": "Czas pacyficzny standardowy", "WEZ": "Czas zachodnioeuropejski standardowy", "MYT": "Malezja", "∅∅∅": "Azory (czas letni)", "LHDT": "Lord Howe (czas letni)", "WIB": "Indonezja Zachodnia", "GYT": "Gujana", "EAT": "Czas wschodnioafrykański", "BOT": "Boliwia", "CHADT": "Chatham (czas letni)", "AKST": "Alaska (czas standardowy)", "CAT": "Czas środkowoafrykański", "ACDT": "Czas środkowoaustralijski letni", "HKST": "Hongkong (czas letni)", "NZDT": "Nowa Zelandia (czas letni)", "TMT": "Turkmenistan (czas standardowy)", "WESZ": "Czas zachodnioeuropejski letni", "ChST": "Czamorro", "UYT": "Urugwaj (czas standardowy)", "HKT": "Hongkong (czas standardowy)", "HADT": "Hawaje-Aleuty (czas letni)", "HAT": "Nowa Fundlandia (czas letni)", "GFT": "Gujana Francuska"},
	}
}
