...
// FmtDateTimeShort returns the short date & time representation of 't' for 'bs_Latn'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (bs *bs_Latn) FmtDateTimeShort(t time.Time) []byte {
...
// FmtDateTimeMedium returns the medium date & time representation of 't' for 'bs_Latn'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (bs *bs_Latn) FmtDateTimeMedium(t time.Time) []byte {
...
// FmtDateTimeLong returns the long date & time representation of 't' for 'bs_Latn'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (bs *bs_Latn) FmtDateTimeLong(t time.Time) []byte {
...
// FmtDateTimeFull returns the full date & time representation of 't' for 'bs_Latn'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (bs *bs_Latn) FmtDateTimeFull(t time.Time) []byte {
