...
func New() locales.Translator {
	return &ar_MR{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"CDT": "التوقيت الصيفي المركزي لأمريكا الشمالية", "WITA": "توقيت وسط إندونيسيا", "CLST": "توقيت شيلي الصيفي", "UYST": "توقيت أورغواي الصيفي", "WIB": "توقيت غرب إندونيسيا", "AEDT": "توقيت شرق أستراليا الصيفي", "ART": "توقيت الأرجنتين الرسمي", "ARST": "توقيت الأرجنتين الصيفي", "EDT": "التوقيت الصيفي الشرقي لأمريكا الشمالية", "HAT": "توقيت نيوفاوندلاند الصيفي", "OESZ": "توقيت شرق أوروبا الصيفي", "WARST": "توقيت غرب الأرجنتين الصيفي", "VET": "توقيت فنزويلا", "PST": "توقيت المحيط الهادي الرسمي", "ACST": "توقيت وسط أستراليا الرسمي", "ACDT": "توقيت وسط أستراليا الصيفي", "CHAST": "توقيت تشاتام الرسمي", "HNT": "توقيت نيوفاوندلاند الرسمي", "AEST": "توقيت شرق أستراليا الرسمي", "MST": "التوقيت الجبلي الرسمي لأمريكا الشمالية", "∅∅∅": "توقيت الأمازون الصيفي", "WIT": "توقيت شرق إندونيسيا", "SRT": "توقيت سورينام", "ACWDT": "توقيت غرب وسط أستراليا الصيفي", "MEZ": "توقيت وسط أوروبا الرسمي", "HAST": "توقيت هاواي ألوتيان الرسمي", "ACWST": "توقيت غرب وسط أستراليا الرسمي", "WAT": "توقيت غرب أفريقيا الرسمي", "ChST": "توقيت تشامورو", "OEZ": "توقيت شرق أوروبا الرسمي", "GMT": "توقيت غرينتش", "AKST": "التوقيت الرسمي لألاسكا", "AKDT": "توقيت ألاسكا الصيفي", "AST": "التوقيت الرسمي الأطلسي", "LHDT": "التوقيت الصيفي للورد هاو", "ECT": "توقيت الإكوادور", "CHADT": "توقيت تشاتام الصيفي", "UYT": "توقيت أورغواي الرسمي", "NZDT": "توقيت نيوزيلندا الصيفي", "BOT": "توقيت بوليفيا", "TMT": "توقيت تركمانستان الرسمي", "TMST": "توقيت تركمانستان الصيفي", "EAT": "توقيت شرق أفريقيا", "ADT": "التوقيت الصيفي الأطلسي", "HADT": "توقيت هاواي ألوتيان الصيفي", "SAST": "توقيت جنوب أفريقيا", "JDT": "توقيت اليابان الصيفي", "PDT": "توقيت المحيط الهادي الصيفي", "SGT": "توقيت سنغافورة", "COST": "توقيت كولومبيا الصيفي", "WAST": "توقيت غرب أفريقيا الصيفي", "AWST": "توقيت غرب أستراليا الرسمي", "AWDT": "توقيت غرب أستراليا الصيفي", "JST": "توقيت اليابان الرسمي", "GYT": "توقيت غيانا", "HKST": "توقيت هونغ كونغ الصيفي", "LHST": "توقيت لورد هاو الرسمي", "WART": "توقيت غرب الأرجنتين الرسمي", "WESZ": "توقيت غرب أوروبا الصيفي", "MYT": "توقيت ماليزيا", "BT": "توقيت بوتان", "NZST": "توقيت نيوزيلندا الرسمي", "GFT": "توقيت غايانا الفرنسية", "HKT": "توقيت هونغ كونغ الرسمي", "CST": "التوقيت الرسمي المركزي لأمريكا الشمالية", "EST": "التوقيت الرسمي الشرقي لأمريكا الشمالية", "CAT": "توقيت وسط أفريقيا", "CLT": "توقيت شيلي الرسمي", "WEZ": "توقيت غرب أوروبا الرسمي", "MDT": "التوقيت الجبلي الصيفي لأمريكا الشمالية", "MESZ": "توقيت وسط أوروبا الصيفي", "IST": "توقيت الهند", "COT": "توقيت كولومبيا الرسمي"},
	}
}
