...
func New() locales.Translator {
	return &sv_SE{
		...
		timezones:              map[string]string{"TMT": "turkmensk normaltid", "WESZ": "västeuropeisk sommartid", "HAT": "Newfoundland, sommartid", "HKST": "Hongkong, sommartid", "AST": "nordamerikansk atlantnormaltid", "EDT": "östnordamerikansk sommartid", "GYT": "Guyanatid", "PST": "västnordamerikansk normaltid", "WEZ": "västeuropeisk normaltid", "LHST": "Lord Howe, normaltid", "ECT": "ecuadoriansk tid", "AKDT": "Alaska, sommartid", "CLT": "chilensk normaltid", "TMST": "turkmensk sommartid", "GMT": "Greenwichtid", "AEST": "östaustralisk normaltid", "ChST": "Chamorrotid", "MYT": "malaysisk tid", "BT": "bhutansk tid", "JST": "japansk normaltid", "NZST": "nyzeeländsk normaltid", "CST": "centralnordamerikansk normaltid", "CDT": "centralnordamerikansk sommartid", "UYT": "uruguayansk normaltid", "MST": "Klippiga bergen, normaltid", "WIB": "västindonesisk tid", "WARST": "västargentinsk sommartid", "GFT": "Franska Guyanatid", "HKT": "Hongkong, normaltid", "SAST": "sydafrikansk tid", "PDT": "västnordamerikansk sommartid", "CLST": "chilensk sommartid", "CHADT": "Chatham, sommartid", "COST": "colombiansk sommartid", "CAT": "centralafrikansk tid", "JDT": "japansk sommartid", "ADT": "nordamerikansk atlantsommartid", "NZDT": "nyzeeländsk sommartid", "WIT": "östindonesisk tid", "VET": "venezuelansk tid", "ART": "östargentinsk normaltid", "ARST": "östargentinsk sommartid", "HAST": "Honolulu, normaltid", "WAST": "västafrikansk sommartid", "ACDT": "centralaustralisk sommartid", "ACWST": "västcentralaustralisk normaltid", "MEZ": "centraleuropeisk normaltid", "SGT": "Singaporetid", "WAT": "västafrikansk normaltid", "MDT": "Klippiga bergen, sommartid", "AKST": "Alaska, normaltid", "HADT": "Honolulu, sommartid", "IST": "indisk tid", "COT": "colombiansk normaltid", "AEDT": "östaustralisk sommartid", "ACWDT": "västcentralaustralisk sommartid", "MESZ": "centraleuropeisk sommartid", "AWST": "västaustralisk normaltid", "BOT": "boliviansk tid", "SRT": "Surinamtid", "AWDT": "västaustralisk sommartid", "UYST": "uruguayansk sommartid", "LHDT": "Lord Howe, sommartid", "EST": "östnordamerikansk normaltid", "∅∅∅": "Amazonas, sommartid", "WITA": "centralindonesisk tid", "OESZ": "östeuropeisk sommartid", "EAT": "östafrikansk tid", "ACST": "centralaustralisk normaltid", "WART": "västargentinsk normaltid", "CHAST": "Chatham, normaltid", "HNT": "Newfoundland, normaltid", "OEZ": "östeuropeisk normaltid"},
	}
}
