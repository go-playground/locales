...
func New() locales.Translator {
	return &mk{
		...
		timezones:              map[string]string{"MYT": "Време во Малезија", "SAST": "Време во Јужноафриканска Република", "AEST": "Стандардно време во Источна Австралија", "ART": "Стандардно време во Аргентина", "JDT": "Летно сметање на времето во Јапонија", "NZST": "Стандардно време во Нов Зеланд", "BT": "Време во Бутан", "HKT": "Стандардно време во Хонг Конг", "ACWST": "Стандардно време во Централна и Западна Австралија", "AKST": "Стандардно време во Аљаска", "MEZ": "Средноевропско стандардно време", "WEZ": "Западноевропско стандардно време", "TMT": "Стандардно време во Туркменистан", "CST": "Централно стандардно време во Северна Америка", "CDT": "Централно летно сметање на времето", "CHAST": "Стандардно време во Четем", "BOT": "Време во Боливија", "AKDT": "Летно сметање на времето во Аљаска", "WARST": "Летно сметање на времето во западна Аргентина", "ARST": "Летно сметање на времето во Аргентина", "AWDT": "Летно сметање на времето во Западна Австралија", "JST": "Стандардно време во Јапонија", "PDT": "Пацифичко летно сметање на времето", "ECT": "Време во Еквадор", "AWST": "Стандардно време во Западна Австралија", "HAST": "Стандардно време во Хаваи - Алеутски острови", "HADT": "Летно сметање на времето во Хаваи - Алеутски острови", "NZDT": "Летно сметање на времето во Нов Зеланд", "SGT": "Време во Сингапур", "WIB": "Време во Западна Индонезија", "OESZ": "Источноевропско летно време", "EDT": "Источно летно сметање на времето", "PST": "Пацифичко стандардно време", "MDT": "MDT", "WITA": "Време во Централна Индонезија", "IST": "Време во Индија", "ACST": "Стандардно време во Централна Австралија", "CHADT": "Летно сметање на времето во Четем", "LHDT": "Летно сметање на времето во Лорд Хау", "CLT": "Стандардно време во Чиле", "WIT": "Време во Источна Индонезија", "WAST": "Западноафриканско летно сметање на времето", "GYT": "Време во Гвајана", "OEZ": "Источноевропско стандардно време", "GMT": "Средно време по Гринич", "CLST": "Летно сметање на времето во Чиле", "∅∅∅": "Летно време во Азорес", "AST": "Атлантско стандардно време", "TMST": "Летно време во Туркменистан", "EAT": "Источноафриканско време", "ACDT": "Летно сметање на времето во Централна Австралија", "COT": "Стандардно време во Колумбија", "EST": "Источно стандардно време", "CAT": "Средноафриканско време", "LHST": "Стандардно време во Лорд Хау", "UYST": "Летно сметање на времето во Уругвај", "GFT": "Време во Француска Гвајана", "ADT": "Атлантско летно сметање на времето", "MESZ": "Средноевропско летно време", "AEDT": "Летно сметање на времето во Источна Австралија", "UYT": "Стандардно време во Уругвај", "VET": "Време во Венецуела", "MST": "MST", "HNT": "Стандардно време на Њуфаундленд", "HAT": "Летно сметање на времето на Њуфаундленд", "COST": "Летно сметање на времето во Колумбија", "ACWDT": "Летно сметање на времето во Централна и Западна Австралија", "WESZ": "Западноевропско летно време", "HKST": "Летно време во Хонг Конг", "WAT": "Западноафриканско стандардно време", "ChST": "Време во Чаморо", "WART": "Стандардно време во западна Аргентина", "SRT": "Време во Суринам"},
	}
}
