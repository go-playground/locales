...
func New() locales.Translator {
	return &az{
		...
		timezones:              map[string]string{"GMT": "Qrinviç Orta Vaxtı", "GFT": "Fransız Qvianası Vaxtı", "WIB": "Qərbi İndoneziya Vaxtı", "HNT": "Nyufaundlend Standart Vaxtı", "OEZ": "Şərqi Avropa Standart Vaxtı", "WARST": "Qərbi Argentina Yay Vaxtı", "AKST": "Alyaska Standart Vaxtı", "OESZ": "Şərqi Avropa Yay Vaxtı", "HAST": "Havay-Aleut Standart Vaxtı", "SAST": "Cənubi Afrika Vaxtı", "PDT": "Şimali Amerika Sakit Okean Yay Vaxtı", "UYST": "Uruqvay Yay Vaxtı", "LHDT": "Lord Hau Yay vaxtı", "MST": "Şimali Dağlıq Amerika Standart Vaxtı", "CST": "Şimali Mərkəzi Amerika Standart Vaxtı", "ACWDT": "Mərkəzi Qərbi Avstraliya Yay Vaxtı", "ARST": "Argentina Yay Vaxtı", "NZST": "Yeni Zelandiya Standart Vaxtı", "CLST": "Çili Yay Vaxtı", "BT": "Butan Vaxtı", "MDT": "Şimali Dağlıq Amerika Yay Vaxtı", "CHADT": "Çatham Yay Vaxtı", "JST": "Yaponiya Standart Vaxtı", "HKST": "Honq Konq Yay Vaxtı", "AKDT": "Alyaska Yay Vaxtı", "NZDT": "Yeni Zelandiya Yay Vaxtı", "COT": "Kolumbiya Standart Vaxtı", "CAT": "Mərkəzi Afrika Vaxtı", "VET": "Venesuela Vaxtı", "AST": "Atlantik Standart Vaxt", "ADT": "Atlantik Yay Vaxtı", "WAT": "Qərbi Afrika Standart Vaxtı", "HKT": "Honq Konq Standart Vaxtı", "AWDT": "Qərbi Avstraliya Yay Vaxtı", "HADT": "Havay-Aleut Yay Vaxtı", "GYT": "Qayana Vaxtı", "UYT": "Uruqvay Standart Vaxtı", "WIT": "Şərqi İndoneziya Vaxtı", "EAT": "Şərqi Afrika Vaxtı", "∅∅∅": "Braziliya Yay Vaxtı", "BOT": "Boliviya Vaxtı", "WAST": "Qərbi Afrika Yay Vaxtı", "WESZ": "Qərbi Avropa Yay Vaxtı", "HAT": "Nyufaundlend Yay Vaxtı", "ACWST": "Mərkəzi Qərbi Avstraliya Standart Vaxtı", "COST": "Kolumbiya Yay Vaxtı", "SGT": "Sinqapur Vaxtı", "EST": "Şimali Şərqi Amerika Standart Vaxtı", "ECT": "Ekvador Vaxtı", "JDT": "Yaponiya Yay Vaxtı", "AEDT": "Şərqi Avstraliya Yay Vaxtı", "LHST": "Lord Hau Standart Vaxtı", "AWST": "Qərbi Avstraliya Standart Vaxtı", "MESZ": "Mərkəzi Avropa Yay Vaxtı", "ACDT": "Mərkəzi Avstraliya Yay Vaxtı", "CHAST": "Çatham Standart Vaxtı", "MEZ": "Mərkəzi Avropa Standart Vaxtı", "TMT": "Türkmənistan Standart Vaxtı", "ChST": "Çamorro Vaxtı", "CLT": "Çili Standart Vaxtı", "PST": "Şimali Amerika Sakit Okean Standart Vaxtı", "TMST": "Türkmənistan Yay Vaxtı", "WART": "Qərbi Argentina Standart Vaxtı", "ART": "Argentina Standart Vaxtı", "IST": "Hindistan Vaxtı", "EDT": "Şimali Şərqi Amerika Yay Vaxtı", "WITA": "Mərkəzi İndoneziya Vaxtı", "WEZ": "Qərbi Avropa Standart Vaxtı", "AEST": "Şərqi Avstraliya Standart Vaxtı", "MYT": "Malayziya Vaxtı", "CDT": "Şimali Mərkəzi Amerika Yay Vaxtı", "ACST": "Mərkəzi Avstraliya Standart Vaxtı", "SRT": "Surinam Vaxtı"},
	}
}
