...
// FmtDateTimeShort returns the short date & time representation of 't' for 'lg'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (lg *lg) FmtDateTimeShort(t time.Time) []byte {

	b := lg.FmtDateShort(t)
	b = append(b, ' ')
	b = append(b, lg.FmtTimeShort(t)...)

	return b
}

// FmtDateTimeMedium returns the medium date & time representation of 't' for 'lg'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (lg *lg) FmtDateTimeMedium(t time.Time) []byte {

	b := lg.FmtDateMedium(t)
	b = append(b, ' ')
	b = append(b, lg.FmtTimeMedium(t)...)

	return b
}

// FmtDateTimeLong returns the long date & time representation of 't' for 'lg'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (lg *lg) FmtDateTimeLong(t time.Time) []byte {

	b := lg.FmtDateLong(t)
	b = append(b, ' ')
	b = append(b, lg.FmtTimeLong(t)...)

	return b
}

// FmtDateTimeFull returns the full date & time representation of 't' for 'lg'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (lg *lg) FmtDateTimeFull(t time.Time) []byte {

	b := lg.FmtDateFull(t)
	b = append(b, ' ')
	b = append(b, lg.FmtTimeFull(t)...)
