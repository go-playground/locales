...
func New() locales.Translator {
	return &ar{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"EAT": "توقيت شرق أفريقيا", "WARST": "توقيت غرب الأرجنتين الصيفي", "CHAST": "توقيت تشاتام الرسمي", "JDT": "توقيت اليابان الصيفي", "EDT": "التوقيت الصيفي الشرقي لأمريكا الشمالية", "WIT": "توقيت شرق إندونيسيا", "WAT": "توقيت غرب أفريقيا الرسمي", "AKDT": "توقيت ألاسكا الصيفي", "SAST": "توقيت جنوب أفريقيا", "CAT": "توقيت وسط أفريقيا", "SGT": "توقيت سنغافورة", "GMT": "توقيت غرينتش", "MESZ": "توقيت وسط أوروبا الصيفي", "WAST": "توقيت غرب أفريقيا الصيفي", "∅∅∅": "توقيت برازيليا الصيفي", "ECT": "توقيت الإكوادور", "ACWDT": "توقيت غرب وسط أستراليا الصيفي", "EST": "التوقيت الرسمي الشرقي لأمريكا الشمالية", "MEZ": "توقيت وسط أوروبا الرسمي", "AKST": "التوقيت الرسمي لألاسكا", "PDT": "توقيت المحيط الهادي الصيفي", "WEZ": "توقيت غرب أوروبا الرسمي", "CST": "التوقيت الرسمي المركزي لأمريكا الشمالية", "HAST": "توقيت هاواي ألوتيان الرسمي", "ChST": "توقيت تشامورو", "MDT": "التوقيت الجبلي الصيفي لأمريكا الشمالية", "VET": "توقيت فنزويلا", "BOT": "توقيت بوليفيا", "TMT": "توقيت تركمانستان الرسمي", "WESZ": "توقيت غرب أوروبا الصيفي", "LHST": "توقيت لورد هاو الرسمي", "CDT": "التوقيت الصيفي المركزي لأمريكا الشمالية", "PST": "توقيت المحيط الهادي الرسمي", "AEDT": "توقيت شرق أستراليا الصيفي", "GYT": "توقيت غيانا", "OESZ": "توقيت شرق أوروبا الصيفي", "MYT": "توقيت ماليزيا", "GFT": "توقيت غايانا الفرنسية", "JST": "توقيت اليابان الرسمي", "AWST": "توقيت غرب أستراليا الرسمي", "OEZ": "توقيت شرق أوروبا الرسمي", "BT": "توقيت بوتان", "SRT": "توقيت سورينام", "HKT": "توقيت هونغ كونغ الرسمي", "AWDT": "توقيت غرب أستراليا الصيفي", "HAT": "توقيت نيوفاوندلاند الصيفي", "NZST": "توقيت نيوزيلندا الرسمي", "WIB": "توقيت غرب إندونيسيا", "UYST": "توقيت أورغواي الصيفي", "LHDT": "التوقيت الصيفي للورد هاو", "ACST": "توقيت وسط أستراليا الرسمي", "AST": "التوقيت الرسمي الأطلسي", "ADT": "التوقيت الصيفي الأطلسي", "ARST": "توقيت الأرجنتين الصيفي", "HADT": "توقيت هاواي ألوتيان الصيفي", "COT": "توقيت كولومبيا الرسمي", "UYT": "توقيت أورغواي الرسمي", "ACDT": "توقيت وسط أستراليا الصيفي", "HKST": "توقيت هونغ كونغ الصيفي", "CHADT": "توقيت تشاتام الصيفي", "ART": "توقيت الأرجنتين الرسمي", "COST": "توقيت كولومبيا الصيفي", "TMST": "توقيت تركمانستان الصيفي", "CLST": "توقيت شيلي الصيفي", "ACWST": "توقيت غرب وسط أستراليا الرسمي", "NZDT": "توقيت نيوزيلندا الصيفي", "IST": "توقيت الهند", "MST": "التوقيت الجبلي الرسمي لأمريكا الشمالية", "WART": "توقيت غرب الأرجنتين الرسمي", "WITA": "توقيت وسط إندونيسيا", "AEST": "توقيت شرق أستراليا الرسمي", "CLT": "توقيت شيلي الرسمي", "HNT": "توقيت نيوفاوندلاند الرسمي"},
	}
}
