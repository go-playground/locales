...
// FmtDateTimeShort returns the short date & time representation of 't' for 'prg_001'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (prg *prg_001) FmtDateTimeShort(t time.Time) []byte {

	b := prg.FmtDateShort(t)
	b = append(b, ' ')
	b = append(b, prg.FmtTimeShort(t)...)

	return b
}

// FmtDateTimeMedium returns the medium date & time representation of 't' for 'prg_001'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (prg *prg_001) FmtDateTimeMedium(t time.Time) []byte {

	b := prg.FmtDateMedium(t)
	b = append(b, ' ')
	b = append(b, prg.FmtTimeMedium(t)...)

	return b
}

// FmtDateTimeLong returns the long date & time representation of 't' for 'prg_001'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (prg *prg_001) FmtDateTimeLong(t time.Time) []byte {

	b := prg.FmtDateLong(t)
	b = append(b, ' ')
	b = append(b, prg.FmtTimeLong(t)...)

	return b
}

// FmtDateTimeFull returns the full date & time representation of 't' for 'prg_001'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (prg *prg_001) FmtDateTimeFull(t time.Time) []byte {

	b := prg.FmtDateFull(t)
	b = append(b, ' ')
	b = append(b, prg.FmtTimeFull(t)...)
