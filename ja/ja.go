...
func New() locales.Translator {
	return &ja{
		...
		timezones:              map[string]string{"MESZ": "中央ヨーロッパ夏時間", "TMT": "トルクメニスタン標準時", "AEDT": "オーストラリア東部夏時間", "EAT": "東アフリカ時間", "UYST": "ウルグアイ夏時間", "ACWDT": "オーストラリア中西部夏時間", "HAST": "ハワイ・アリューシャン標準時", "CAT": "中央アフリカ時間", "CST": "アメリカ中部標準時", "CHAST": "チャタム標準時", "ECT": "エクアドル時間", "SAST": "南アフリカ標準時", "PDT": "アメリカ太平洋夏時間", "NZDT": "ニュージーランド夏時間", "SRT": "スリナム時間", "HKST": "香港夏時間", "WEZ": "西ヨーロッパ標準時", "UYT": "ウルグアイ標準時", "HADT": "ハワイ・アリューシャン夏時間", "WAST": "西アフリカ夏時間", "WIT": "インドネシア東部時間", "ACST": "オーストラリア中部標準時", "AWST": "オーストラリア西部標準時", "ART": "アルゼンチン標準時", "SGT": "シンガポール標準時", "LHST": "ロードハウ標準時", "AKST": "アラスカ標準時", "AST": "大西洋標準時", "BOT": "ボリビア時間", "HNT": "ニューファンドランド標準時", "HAT": "ニューファンドランド夏時間", "OESZ": "東ヨーロッパ夏時間", "ChST": "チャモロ時間", "JDT": "日本夏時間", "WART": "西部アルゼンチン標準時", "HKT": "香港標準時", "EST": "アメリカ東部標準時", "NZST": "ニュージーランド標準時", "COST": "コロンビア夏時間", "CLT": "チリ標準時", "CDT": "アメリカ中部夏時間", "ACDT": "オーストラリア中部夏時間", "CHADT": "チャタム夏時間", "ADT": "大西洋夏時間", "AWDT": "オーストラリア西部夏時間", "WAT": "西アフリカ標準時", "WESZ": "西ヨーロッパ夏時間", "TMST": "トルクメニスタン夏時間", "OEZ": "東ヨーロッパ標準時", "ARST": "アルゼンチン夏時間", "WITA": "インドネシア中部時間", "WIB": "インドネシア西部時間", "GMT": "グリニッジ標準時", "MST": "アメリカ山地標準時", "MDT": "アメリカ山地夏時間", "AKDT": "アラスカ夏時間", "JST": "日本標準時", "WARST": "西部アルゼンチン夏時間", "MEZ": "中央ヨーロッパ標準時", "∅∅∅": "アマゾン夏時間", "COT": "コロンビア標準時", "GYT": "ガイアナ時間", "LHDT": "ロードハウ夏時間", "MYT": "マレーシア時間", "IST": "インド標準時", "EDT": "アメリカ東部夏時間", "AEST": "オーストラリア東部標準時", "BT": "ブータン時間", "VET": "ベネズエラ時間", "ACWST": "オーストラリア中西部標準時", "PST": "アメリカ太平洋標準時", "CLST": "チリ夏時間", "GFT": "仏領ギアナ時間"},
	}
}
