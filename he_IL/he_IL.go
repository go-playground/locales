...
func New() locales.Translator {
	return &he_IL{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"AKST": "שעון אלסקה (חורף)", "AWDT": "שעון מערב אוסטרליה (קיץ)", "OESZ": "שעון מזרח אירופה (קיץ)", "LHDT": "שעון אי הלורד האו (קיץ)", "WARST": "שעון מערב ארגנטינה (קיץ)", "CHADT": "שעון צ׳טהאם (קיץ)", "ACWST": "שעון מרכז-מערב אוסטרליה (חורף)", "∅∅∅": "שעון אמזונס (קיץ)", "UYST": "שעון אורוגוואי (קיץ)", "IST": "שעון הודו", "WAST": "שעון מערב אפריקה (קיץ)", "OEZ": "שעון מזרח אירופה (חורף)", "MYT": "שעון מלזיה", "BOT": "שעון בוליביה", "WESZ": "שעון מערב אירופה (קיץ)", "SGT": "שעון סינגפור", "EST": "שעון החוף המזרחי (חורף)", "CLT": "שעון צ׳ילה (חורף)", "MST": "שעון אזור ההרים בארה״ב (חורף)", "GMT": "שעון גריניץ׳\u200f", "AEDT": "שעון מזרח אוסטרליה (קיץ)", "ChST": "שעון צ׳אמורו", "HKT": "שעון הונג קונג (חורף)", "HADT": "שעון קיץ האיים האלאוטיים הוואי", "COT": "שעון קולומביה (חורף)", "COST": "שעון קולומביה (קיץ)", "LHST": "שעון אי הלורד האו (חורף)", "ACST": "שעון מרכז אוסטרליה (חורף)", "MESZ": "שעון מרכז אירופה (קיץ)", "WEZ": "שעון מערב אירופה (חורף)", "UYT": "שעון אורוגוואי (חורף)", "ECT": "שעון אקוודור", "AST": "שעון האוקיינוס האטלנטי (חורף)", "ARST": "שעון ארגנטינה (קיץ)", "NZDT": "שעון ניו זילנד (קיץ)", "CLST": "שעון צ׳ילה (קיץ)", "BT": "שעון בהוטן", "ACDT": "שעון מרכז אוסטרליה (קיץ)", "CHAST": "שעון צ׳טהאם (חורף)", "WITA": "שעון מרכז אינדונזיה", "JST": "שעון יפן (חורף)", "MEZ": "שעון מרכז אירופה (חורף)", "GYT": "שעון גויאנה", "WIT": "שעון מזרח אינדונזיה", "EAT": "שעון מזרח אפריקה", "MDT": "שעון אזור ההרים בארה״ב (קיץ)", "ACWDT": "שעון מרכז-מערב אוסטרליה (קיץ)", "EDT": "שעון החוף המזרחי (קיץ)", "HAT": "שעון ניופאונדלנד (קיץ)", "GFT": "שעון גיאנה הצרפתית", "HKST": "שעון הונג קונג (קיץ)", "ADT": "שעון האוקיינוס האטלנטי (קיץ)", "SAST": "שעון דרום אפריקה", "HNT": "שעון ניופאונדלנד (חורף)", "TMT": "שעון טורקמניסטן (חורף)", "AEST": "שעון מזרח אוסטרליה (חורף)", "CDT": "שעון מרכז ארה״ב (קיץ)", "WART": "שעון מערב ארגנטינה (חורף)", "JDT": "שעון יפן (קיץ)", "PST": "שעון רגיל האוקיינוס השקט", "PDT": "שעון קיץ, מערב ארה״ב (לוס אנג׳לס)", "WIB": "שעון מערב אינדונזיה", "VET": "שעון ונצואלה", "AKDT": "שעון אלסקה (קיץ)", "ART": "שעון ארגנטינה (חורף)", "HAST": "שעון רגיל האיים האלאוטיים הוואי", "CST": "שעון מרכז ארה״ב (חורף)", "SRT": "שעון סורינאם", "AWST": "שעון מערב אוסטרליה (חורף)", "TMST": "שעון טורקמניסטן (קיץ)", "CAT": "שעון מרכז אפריקה", "NZST": "שעון ניו זילנד (חורף)", "WAT": "שעון מערב אפריקה (חורף)"},
	}
}
