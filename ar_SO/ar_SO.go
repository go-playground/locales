...
func New() locales.Translator {
	return &ar_SO{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"WAT": "توقيت غرب أفريقيا الرسمي", "CLT": "توقيت شيلي الرسمي", "SRT": "توقيت سورينام", "HKST": "توقيت هونغ كونغ الصيفي", "COT": "توقيت كولومبيا الرسمي", "OESZ": "توقيت شرق أوروبا الصيفي", "AEST": "توقيت شرق أستراليا الرسمي", "ChST": "توقيت تشامورو", "MST": "MST", "ACWST": "توقيت غرب وسط أستراليا الرسمي", "NZDT": "توقيت نيوزيلندا الصيفي", "COST": "توقيت كولومبيا الصيفي", "WESZ": "توقيت غرب أوروبا الصيفي", "CDT": "التوقيت الصيفي المركزي لأمريكا الشمالية", "ADT": "التوقيت الصيفي الأطلسي", "BOT": "توقيت بوليفيا", "ACWDT": "توقيت غرب وسط أستراليا الصيفي", "AWST": "توقيت غرب أستراليا الرسمي", "TMST": "توقيت تركمانستان الصيفي", "CLST": "توقيت شيلي الصيفي", "WIT": "توقيت شرق إندونيسيا", "EAT": "توقيت شرق أفريقيا", "LHST": "توقيت لورد هاو الرسمي", "MYT": "توقيت ماليزيا", "VET": "توقيت فنزويلا", "EST": "التوقيت الرسمي الشرقي لأمريكا الشمالية", "MEZ": "توقيت وسط أوروبا الرسمي", "WITA": "توقيت وسط إندونيسيا", "SAST": "توقيت جنوب أفريقيا", "PDT": "توقيت المحيط الهادي الصيفي", "CHADT": "توقيت تشاتام الصيفي", "HAT": "توقيت نيوفاوندلاند الصيفي", "ECT": "توقيت الإكوادور", "AKDT": "توقيت ألاسكا الصيفي", "HAST": "توقيت هاواي ألوتيان الرسمي", "ACST": "توقيت وسط أستراليا الرسمي", "ARST": "توقيت الأرجنتين الصيفي", "LHDT": "التوقيت الصيفي للورد هاو", "WEZ": "توقيت غرب أوروبا الرسمي", "∅∅∅": "توقيت أزورس الصيفي", "JST": "توقيت اليابان الرسمي", "MESZ": "توقيت وسط أوروبا الصيفي", "IST": "توقيت الهند", "WAST": "توقيت غرب أفريقيا الصيفي", "OEZ": "توقيت شرق أوروبا الرسمي", "GMT": "توقيت غرينتش", "UYST": "توقيت أورغواي الصيفي", "HKT": "توقيت هونغ كونغ الرسمي", "CHAST": "توقيت تشاتام الرسمي", "JDT": "توقيت اليابان الصيفي", "ART": "توقيت الأرجنتين الرسمي", "TMT": "توقيت تركمانستان الرسمي", "NZST": "توقيت نيوزيلندا الرسمي", "PST": "توقيت المحيط الهادي الرسمي", "WIB": "توقيت غرب إندونيسيا", "CAT": "توقيت وسط أفريقيا", "ACDT": "توقيت وسط أستراليا الصيفي", "WART": "توقيت غرب الأرجنتين الرسمي", "WARST": "توقيت غرب الأرجنتين الصيفي", "BT": "توقيت بوتان", "GFT": "توقيت غايانا الفرنسية", "AEDT": "توقيت شرق أستراليا الصيفي", "UYT": "توقيت أورغواي الرسمي", "AST": "التوقيت الرسمي الأطلسي", "AWDT": "توقيت غرب أستراليا الصيفي", "SGT": "توقيت سنغافورة", "GYT": "توقيت غيانا", "CST": "التوقيت الرسمي المركزي لأمريكا الشمالية", "MDT": "MDT", "AKST": "التوقيت الرسمي لألاسكا", "HADT": "توقيت هاواي ألوتيان الصيفي", "EDT": "التوقيت الصيفي الشرقي لأمريكا الشمالية", "HNT": "توقيت نيوفاوندلاند الرسمي"},
	}
}
