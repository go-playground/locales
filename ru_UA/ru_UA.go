...
func New() locales.Translator {
	return &ru_UA{
		...
		timezones:              map[string]string{"JDT": "Япония, летнее время", "AST": "Атлантическое стандартное время", "CDT": "Центральная Америка, летнее время", "OESZ": "Восточная Европа, летнее время", "LHDT": "Лорд-Хау, летнее время", "UYT": "Уругвай, стандартное время", "WITA": "Центральная Индонезия", "MEZ": "Центральная Европа, стандартное время", "IST": "Индия", "OEZ": "Восточная Европа, стандартное время", "AWDT": "Западная Австралия, летнее время", "GYT": "Гайана", "EAT": "Восточная Африка", "ADT": "Атлантическое летнее время", "PDT": "Тихоокеанское летнее время", "LHST": "Лорд-Хау, стандартное время", "WIT": "Восточная Индонезия", "VET": "Венесуэла", "ACWST": "Центральная Австралия, западное стандартное время", "HNT": "Ньюфаундленд, стандартное время", "TMST": "Туркмения, летнее время", "CLST": "Чили, летнее время", "COT": "Колумбия, стандартное время", "WAST": "Западная Африка, летнее время", "CHADT": "Чатем, летнее время", "WARST": "Западная Аргентина, летнее время", "CST": "Центральная Америка, стандартное время", "AWST": "Западная Австралия, стандартное время", "ChST": "Чаморро", "MDT": "Горное летнее время (США)", "UYST": "Уругвай, летнее время", "HAT": "Ньюфаундленд, летнее время", "SGT": "Сингапур", "SRT": "Суринам", "ART": "Аргентина, стандартное время", "AKST": "Аляска, стандартное время", "NZDT": "Новая Зеландия, летнее время", "SAST": "Южная Африка", "HKT": "Гонконг, стандартное время", "HAST": "Гавайско-алеутское стандартное время", "BOT": "Боливия", "∅∅∅": "Акри летнее время", "WEZ": "Западная Европа, стандартное время", "ACST": "Центральная Австралия, стандартное время", "JST": "Япония, стандартное время", "AKDT": "Аляска, летнее время", "HADT": "Гавайско-алеутское летнее время", "CLT": "Чили, стандартное время", "TMT": "Туркмения, стандартное время", "BT": "Бутан", "WART": "Западная Аргентина, стандартное время", "ECT": "Эквадор", "MESZ": "Центральная Европа, летнее время", "CAT": "Центральная Африка", "AEDT": "Восточная Австралия, летнее время", "ACWDT": "Центральная Австралия, западное летнее время", "ARST": "Аргентина, летнее время", "EDT": "Восточная Америка, летнее время", "PST": "Тихоокеанское стандартное время", "HKST": "Гонконг, летнее время", "NZST": "Новая Зеландия, стандартное время", "COST": "Колумбия, летнее время", "WIB": "Западная Индонезия", "GFT": "Французская Гвиана", "EST": "Восточная Америка, стандартное время", "WESZ": "Западная Европа, летнее время", "WAT": "Западная Африка, стандартное время", "AEST": "Восточная Австралия, стандартное время", "GMT": "Среднее время по Гринвичу", "ACDT": "Центральная Австралия, летнее время", "CHAST": "Чатем, стандартное время", "MST": "Горное стандартное время (США)", "MYT": "Малайзия"},
	}
}
