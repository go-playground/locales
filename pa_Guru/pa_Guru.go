...
// FmtDateTimeShort returns the short date & time representation of 't' for 'pa_Guru'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (pa *pa_Guru) FmtDateTimeShort(t time.Time) []byte {
...
// FmtDateTimeMedium returns the medium date & time representation of 't' for 'pa_Guru'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (pa *pa_Guru) FmtDateTimeMedium(t time.Time) []byte {
...
// FmtDateTimeLong returns the long date & time representation of 't' for 'pa_Guru'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (pa *pa_Guru) FmtDateTimeLong(t time.Time) []byte {
...
// FmtDateTimeFull returns the full date & time representation of 't' for 'pa_Guru'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (pa *pa_Guru) FmtDateTimeFull(t time.Time) []byte {
