...
// FmtDateTimeShort returns the short date & time representation of 't' for 'en'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (en *en) FmtDateTimeShort(t time.Time) []byte {
...
// FmtDateTimeMedium returns the medium date & time representation of 't' for 'en'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (en *en) FmtDateTimeMedium(t time.Time) []byte {
...
// FmtDateTimeLong returns the long date & time representation of 't' for 'en'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (en *en) FmtDateTimeLong(t time.Time) []byte {
...
// FmtDateTimeFull returns the full date & time representation of 't' for 'en'
// returned as a []byte just in case the caller wishes to add more and can help
// avoid allocations; otherwise just cast as string.
func (en *en) FmtDateTimeFull(t time.Time) []byte {
