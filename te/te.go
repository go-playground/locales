...
func New() locales.Translator {
	return &te{
		...
		timezones:              map[string]string{"WARST": "పశ్చిమ అర్జెంటీనా వేసవి సమయం", "MST": "మకావ్ ప్రామాణిక సమయం", "CHADT": "చాథమ్ పగటి వెలుతురు సమయం", "SAST": "దక్షిణ ఆఫ్రికా ప్రామాణిక సమయం", "ChST": "చామర్రో ప్రామాణిక సమయం", "WAT": "పశ్చిమ ఆఫ్రికా ప్రామాణిక సమయం", "WIB": "పశ్చిమ ఇండోనేషియా సమయం", "AEST": "తూర్పు ఆస్ట్రేలియా ప్రామాణిక సమయం", "MEZ": "సెంట్రల్ యూరోపియన్ ప్రామాణిక సమయం", "TMT": "తుర్క్మెనిస్థాన్ ప్రామాణిక సమయం", "WEZ": "పశ్చిమ యూరోపియన్ ప్రామాణిక సమయం", "CLST": "చిలీ వేసవి సమయం", "CST": "మధ్యమ ప్రామాణిక సమయం", "ACDT": "ఆస్ట్రేలియా మధ్యమ పగటి సమయం", "LHDT": "లార్డ్ హోవ్ పగటి సమయం", "MYT": "మలేషియా సమయం", "ECT": "ఈక్వడార్ సమయం", "IST": "భారతదేశ సమయం", "NZDT": "న్యూజిల్యాండ్ పగటి వెలుతురు సమయం", "OEZ": "తూర్పు యూరోపియన్ ప్రామాణిక సమయం", "CHAST": "చాథమ్ ప్రామాణిక సమయం", "AKST": "అలాస్కా ప్రామాణిక సమయం", "CAT": "సెంట్రల్ ఆఫ్రికా సమయం", "WAST": "పశ్చిమ ఆఫ్రికా వేసవి సమయం", "GFT": "ఫ్రెంచ్ గయానా సమయం", "HKST": "హాంకాంగ్ వేసవి సమయం", "VET": "వెనిజులా సమయం", "MESZ": "సెంట్రల్ యూరోపియన్ వేసవి సమయం", "OESZ": "తూర్పు యూరోపియన్ వేసవి సమయం", "ACWDT": "మధ్యమ ఆస్ట్రేలియన్ పశ్చిమ పగటి సమయం", "JST": "జపాన్ ప్రామాణిక సమయం", "BOT": "బొలీవియా సమయం", "HADT": "హవాయ్-అల్యూషియన్ పగటి వెలుతురు సమయం", "GMT": "గ్రీన్\u200cవిచ్ సగటు సమయం", "GYT": "గయానా సమయం", "LHST": "లార్డ్ హోవ్ ప్రామాణిక సమయం", "AKDT": "అలాస్కా పగటి సమయం", "EDT": "తూర్పు పగటి సమయం", "AEDT": "తూర్పు ఆస్ట్రేలియా పగటి సమయం", "WIT": "తూర్పు ఇండోనేషియా సమయం", "WITA": "సెంట్రల్ ఇండోనేషియా సమయం", "JDT": "జపాన్ పగటి వెలుతురు సమయం", "EST": "తూర్పు ప్రామాణిక సమయం", "HNT": "న్యూఫౌండ్ ల్యాండ్ ప్రామాణిక సమయం", "CDT": "మధ్యమ పగటి సమయం", "MDT": "మకావ్ వేసవి సమయం", "COST": "కొలంబియా వేసవి సమయం", "CLT": "చిలీ ప్రామాణిక సమయం", "ART": "అర్జెంటీనా ప్రామాణిక సమయం", "PDT": "పసిఫిక్ పగటి సమయం", "COT": "కొలంబియా ప్రామాణిక సమయం", "ACWST": "మధ్యమ ఆస్ట్రేలియా పశ్చిమ ప్రామాణిక సమయం", "AWST": "పశ్చిమ ఆస్ట్రేలియన్ ప్రామాణిక సమయం", "TMST": "తుర్క్మెనిస్థాన్ వేసవి సమయం", "UYT": "ఉరుగ్వే ప్రామాణిక సమయం", "BT": "భూటాన్ సమయం", "ACST": "ఆస్ట్రేలియా మధ్యమ ప్రామాణిక సమయం", "SRT": "సూరినామ్ సమయం", "∅∅∅": "అజోర్స్ వేసవి సమయం", "HKT": "హాంకాంగ్ ప్రామాణిక సమయం", "ADT": "అట్లాంటిక్ పగటి సమయం", "NZST": "న్యూజిల్యాండ్ ప్రామాణిక సమయం", "HAT": "న్యూఫౌండ్ ల్యాండ్ పగటి సమయం", "WART": "పశ్చిమ అర్జెంటీనా ప్రామాణిక సమయం", "AWDT": "పశ్చిమ ఆస్ట్రేలియన్ పగటి సమయం", "PST": "పసిఫిక్ ప్రామాణిక సమయం", "WESZ": "పశ్చిమ యూరోపియన్ వేసవి సమయం", "EAT": "తూర్పు ఆఫ్రికా సమయం", "UYST": "ఉరుగ్వే వేసవి సమయం", "AST": "అట్లాంటిక్ ప్రామాణిక సమయం", "ARST": "ఆర్జెంటీనా వేసవి సమయం", "HAST": "హవాయ్-అల్యూషియన్ ప్రామాణిక సమయం", "SGT": "సింగపూర్ ప్రామాణిక సమయం"},
	}
}
